...
public:
	...
	virtual bool Evaluate( const std::vector<unsigned char>&, std::vector<float>&, bool = false, size_t = 0,
		bool = false ) const = 0;
...
public:
	...
	bool Evaluate( const std::vector<unsigned char>&, std::vector<float>&, bool = false, size_t = 0,
		bool = false ) const;

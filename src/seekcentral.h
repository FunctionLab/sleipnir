 ...
 */
    ...
    public:
        ...
        bool InitializeFromSeekMiner(
                ...
                gsl_rng *rand = NULL, const bool useNibble = false, const int numThreads = 8, const float percentDatasetCoverage = 0.5);
        ...
        bool InitializeQuery(const string &output_dir, const string &query,
                        ...
                        const bool bNegativeCor = false, const bool bCheckDsetSize = false, const float percentDatasetCoverage = 0.5);
    ...
    private:
        ...
        float m_fPercentDatasetCoverage;
        int m_iNumDatasetCoverage;
    };

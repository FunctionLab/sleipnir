/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\MCluster\ -i ..\..\..\tools\MCluster\MCluster.ggo 
...
const char *gengetopt_args_info_purpose = "Hierarchical clustering tool.";

const char *gengetopt_args_info_usage = "Usage: MCluster [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nMain:",
  "  -i, --input=filename    Input PCL/DAT/DAB file",
  "  -o, --output=filename   Output GTR file",
  ...
  "\nPreprocessing:",
  "  -n, --normalize         Normalize similarities before clustering  \n                            (default=on)",
  "  -f, --flip              Invert similarities before clustering  (default=off)",
  "  -e, --epsilon=DOUBLE    Remove genes with no correlations above epsilon",
  "  -p, --power=DOUBLE      Power transform similarities  (default=`1')",
...
char *cmdline_parser_distance_values[] = {"pearson", "euclidean", "kendalls", "kolm-smir", "spearman", 0} ;	/* Possible values for distance.  */
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->power_arg = 1;
  args_info->power_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->flip_help = gengetopt_args_info_help[10] ;
  args_info->epsilon_help = gengetopt_args_info_help[11] ;
  args_info->power_help = gengetopt_args_info_help[12] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->power_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->power_given)
    write_into_file(outfile, "power", args_info->power_orig, 0);
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:d:w:nfe:p:s:v:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'w':	/* Input weights file.  */
          ...
          break;
        case 'n':	/* Normalize similarities before clustering.  */
          ...
          break;
        case 'f':	/* Invert similarities before clustering.  */
          ...
          break;
        case 'e':	/* Remove genes with no correlations above epsilon.  */
        
        
          if (update_arg( (void *)&(args_info->epsilon_arg), 
               &(args_info->epsilon_orig), &(args_info->epsilon_given),
              &(local_args_info.epsilon_given), optarg, 0, 0, ARG_DOUBLE,
              check_ambiguity, override, 0, 0,
              "epsilon", 'e',
              additional_error))
            goto failure;
          ...
          break;
        case 'p':	/* Power transform similarities.  */
        
        
          if (update_arg( (void *)&(args_info->power_arg), 
               &(args_info->power_orig), &(args_info->power_given),
              &(local_args_info.power_given), optarg, 0, "1", ARG_DOUBLE,
              check_ambiguity, override, 0, 0,
              "power", 'p',
              additional_error))
            goto failure;

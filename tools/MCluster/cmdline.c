/*
  ...
  /home/chuttenh/hg/sleipnir/trunk/../extlib/gengetopt-2.22/bin/gengetopt -iMCluster.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_usage = "Usage: MCluster [OPTIONS]... [FILES]...";
...
char *cmdline_parser_distance_values[] = {"pearson", "euclidean", "kendalls", "kolm-smir", "spearman",
                                          0};    /* Possible values for distance.  */
        ...
        switch (c) {
            ...
            case 'd':    /* Similarity measure.  */
                ...
                if (update_arg((void *) &(args_info->distance_arg),
                               ...
                               &(local_args_info.distance_given), optarg, cmdline_parser_distance_values, "pearson",
                               ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "distance", 'd',
                               additional_error))

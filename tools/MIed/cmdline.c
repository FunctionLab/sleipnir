/*
  ...
  /tigress-hsm/GENOMICS/sleipnir/trunk/../extlib/gengetopt-2.22/bin/gengetopt -iMIed.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_purpose = "A Dab data set pairwise mutual information calculator.";

const char *gengetopt_args_info_usage = "Usage: MIed [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -u, --union                Use the union genes of two datasets while assign \n                               missing values randomly  (default=off)",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->verbosity_help = gengetopt_args_info_help[5] ;
  args_info->random_help = gengetopt_args_info_help[6] ;
  args_info->start_help = gengetopt_args_info_help[7] ;
  args_info->end_help = gengetopt_args_info_help[8] ;
  args_info->union_help = gengetopt_args_info_help[9] ;
  args_info->directory_help = gengetopt_args_info_help[10] ;
  args_info->datasets_help = gengetopt_args_info_help[11] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVo:v:r:S:E:ud:f:Z:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'E':	/* Process only up to this ending dataset index.  */
          ...
          break;
        case 'u':	/* Use the union genes of two datasets while assign missing values randomly.  */
        
        
          if (update_arg((void *)&(args_info->union_flag), 0, &(args_info->union_given),
              &(local_args_info.union_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "union", 'u',
              additional_error))
            goto failure;
        ...
        case 'd':	/* input directory.  */
          ...
          break;
        case 'f':	/* Calculate MI for datasets in given file against all datasets.  */

/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Seqs2Ngrams\ -i ..\..\..\tools\Seqs2Ngrams\Seqs2Ngrams.ggo 
...
const char *gengetopt_args_info_purpose = "Convert sequence data to n-gram counts";

const char *gengetopt_args_info_usage = "Usage: Seqs2Ngrams [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nMain:",
  "  -i, --input=filename   Sequence input FASTA file",
  "  -o, --output=filename  DAT/DAB output file",
  "  -n, --n=INT            N-gram size  (default=`7')",
  "\nMiscellaneous:",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->n_help = gengetopt_args_info_help[5] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:n:mzg:v:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'V':	/* Print version and exit.  */
          ...
          break;
        case 'i':	/* Sequence input FASTA file.  */
        ...
        case 'n':	/* N-gram size.  */
          ...
          if (update_arg( (void *)&(args_info->n_arg), 
              ...
              &(local_args_info.n_given), optarg, 0, "7", ARG_INT,
              check_ambiguity, override, 0, 0,
              "n", 'n',
              additional_error))
            goto failure;
        ...
        case 'm':	/* Normalize to the range [0,1].  */
          ...
          if (update_arg((void *)&(args_info->normalize_flag), 0, &(args_info->normalize_given),
              ...
              check_ambiguity, override, 1, 0, "normalize", 'm',
              additional_error))
            goto failure;

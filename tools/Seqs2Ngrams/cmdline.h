...
struct gengetopt_args_info
{
  ...
  char * input_arg;	/**< @brief Sequence input FASTA file.  */
  char * input_orig;	/**< @brief Sequence input FASTA file original value given at command line.  */
  const char *input_help; /**< @brief Sequence input FASTA file help description.  */
  char * output_arg;	/**< @brief DAT/DAB output file.  */
  char * output_orig;	/**< @brief DAT/DAB output file original value given at command line.  */
  const char *output_help; /**< @brief DAT/DAB output file help description.  */
  int n_arg;	/**< @brief N-gram size (default='7').  */
  char * n_orig;	/**< @brief N-gram size original value given at command line.  */
  const char *n_help; /**< @brief N-gram size help description.  */

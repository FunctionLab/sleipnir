...
const char *gengetopt_args_info_usage = "Usage: SeekServer [OPTION]... [FILE]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -g, --guided                  Enable guided version which accepts an extra\n                                  gene_set paramater to guide the search (used\n                                  with CVCUSTOM search)  (default=off)",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->guided_help = gengetopt_args_info_help[23] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->guided_given)
    write_into_file(outfile, "guided", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVt:x:i:d:p:P:u:U:Q:R:n:T:c:eNb:OB:g", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'B':	/* Utilize a second CDatabase collection. Path to the second CDatabase's setting file..  */
          ...
          break;
        case 'g':	/* Enable guided version which accepts an extra gene_set paramater to guide the search (used with CVCUSTOM search).  */
        
        
          if (update_arg((void *)&(args_info->guided_flag), 0, &(args_info->guided_given),
              &(local_args_info.guided_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "guided", 'g',
              additional_error))
            goto failure;

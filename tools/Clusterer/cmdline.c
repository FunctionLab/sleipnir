...
const char *cmdline_parser_distance_values[] = {"pearson", "euclidean", "kendalls", "kolm-smir", "spearman",
                                                "quickpear", 0}; /*< Possible values for distance. */
        ...
        switch (c) {
            ...
            case 'a':    /* Clustering algorithm.  */
                ...
                if (update_arg((void *) &(args_info->algorithm_arg),
                               ...
                               &(local_args_info.algorithm_given), optarg, cmdline_parser_algorithm_values, "kmeans",
                               ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "algorithm", 'a',
                               additional_error))

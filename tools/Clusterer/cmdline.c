/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Clusterer\ -i ..\..\..\tools\Clusterer\Clusterer.ggo 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->autocorrelate_help = gengetopt_args_info_help[17] ;
  args_info->random_help = gengetopt_args_info_help[18] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:a:w:d:k:m:o:M:e:s:ncr:v:", long_options, &option_index);

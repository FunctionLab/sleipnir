/*
  ...
  ..\..\..\..\extlib\proj\vs2008\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Clusterer\ -i ..\..\..\tools\Clusterer\Clusterer.ggo 
...
const char *gengetopt_args_info_usage = "Usage: Clusterer [OPTIONS]...";
...
char *cmdline_parser_algorithm_values[] = {"qtc", "kmeans", 0} ;	/* Possible values for algorithm.  */
char *cmdline_parser_distance_values[] = {"pearson", "euclidean", "kendalls", "kolm-smir", "spearman", "quickpear", 0} ;	/* Possible values for distance.  */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->pcl_help = gengetopt_args_info_help[15] ;
  args_info->skip_help = gengetopt_args_info_help[16] ;
  args_info->normalize_help = gengetopt_args_info_help[17] ;
  args_info->autocorrelate_help = gengetopt_args_info_help[18] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:a:w:d:k:m:o:M:e:p:s:ncr:v:", long_options, &option_index);

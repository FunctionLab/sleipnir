/*
  ...
  /Genomics/fgrid/function/sleipnir-extlib/gengetopt-2.22/src/gengetopt -iDChecker.ggo --default-optional -u -N -e 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->invert_help = gengetopt_args_info_help[23] ;
  args_info->sse_help = gengetopt_args_info_help[25] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:w:d:a:R:b:fm:M:e:g:G:c:C:l:ntspv:", long_options, &option_index);

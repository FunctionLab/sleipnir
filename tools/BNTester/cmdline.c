/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\BNTester\ -i ..\..\..\tools\BNTester\BNTester.ggo 
...
const char *gengetopt_args_info_purpose = "Bayes net evaluation";

const char *gengetopt_args_info_usage = "Usage: BNTester [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -e, --genee=filename     Term inclusion file",
  "\nNetwork Features:",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->pnl_help = gengetopt_args_info_help[15] ;
  args_info->function_help = gengetopt_args_info_help[16] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVd:D:i:o:yg:G:e:zpfuv:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'y':	/* Evaluate pairs without an answer.  */
          ...
          if (update_arg((void *)&(args_info->everything_flag), 0, &(args_info->everything_given),
              ...
              check_ambiguity, override, 1, 0, "everything", 'y',
              additional_error))
            goto failure;

/*
  ...
  /r01/tergeo/chuttenh/sleipnir/trunk/../extlib/gengetopt-2.22/bin/gengetopt -iBNTester.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_usage = "Usage: BNTester [OPTIONS]... [FILES]...";

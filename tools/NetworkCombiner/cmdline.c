/*
  ...
  /r03/cypark/sleipnir/../sleipnir-extlib/gengetopt-2.22/src/gengetopt -iNetworkCombiner.ggo --default-optional -u -N -e 
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVo:v:d:m", long_options, &option_index);

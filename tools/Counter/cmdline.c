...
cmdline_parser_required2(struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error) {
    ...
    if (args_info->Mode_group_counter == 0) {
        fprintf(stderr, "%s: %d options of group Mode were given. One is required.%s\n", prog_name,
                args_info->Mode_group_counter, (additional_error ? additional_error : ""));
        error = 1;
    }
...
cmdline_parser_internal(int argc, char *const *argv, struct gengetopt_args_info *args_info,
    ...
    while (1) {
        ...
        c = getopt_long(argc, argv, "hVw:k:n:o:O:d:s:e:X:g:G:P:c:C:qQjJuUWDFf:Nb:Z:Sp:a:rR:y:lxmMt:v:L", long_options,
                        &option_index);

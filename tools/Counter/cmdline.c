/*
  ...
  gengetopt -iCounter.ggo --default-optional -u -N -e 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->default_help = gengetopt_args_info_help[28] ;
  args_info->zeros_help = gengetopt_args_info_help[29] ;
  args_info->genewise_help = gengetopt_args_info_help[30] ;
  args_info->pseudocounts_help = gengetopt_args_info_help[32] ;
  args_info->alphas_help = gengetopt_args_info_help[33] ;
  args_info->regularize_help = gengetopt_args_info_help[34] ;
  args_info->reggroups_help = gengetopt_args_info_help[35] ;
  args_info->temporary_help = gengetopt_args_info_help[37] ;
  args_info->smile_help = gengetopt_args_info_help[38] ;
  args_info->xdsl_help = gengetopt_args_info_help[39] ;
  args_info->memmap_help = gengetopt_args_info_help[40] ;
  args_info->memmapout_help = gengetopt_args_info_help[41] ;
  args_info->threads_help = gengetopt_args_info_help[42] ;
  args_info->verbosity_help = gengetopt_args_info_help[43] ;
  args_info->logratio_help = gengetopt_args_info_help[44] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVw:k:n:o:O:d:s:e:X:g:G:P:c:C:qQjJuUWFb:Z:Sp:a:rR:y:lxmMt:v:L", long_options, &option_index);

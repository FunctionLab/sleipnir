/*
  ...
  /r01/tergeo/chuttenh/sleipnir/trunk/../extlib/gengetopt-2.22/bin/gengetopt -iCounter.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -c, --counts=directory        Directory containing count files",
  ...
  "  -g, --genes=filename          Gene ID text file",
  "\nNetwork Features:",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->pseudocounts_help = gengetopt_args_info_help[15] ;
  args_info->alphas_help = gengetopt_args_info_help[16] ;
  args_info->temporary_help = gengetopt_args_info_help[18] ;
  args_info->smile_help = gengetopt_args_info_help[19] ;
  args_info->xdsl_help = gengetopt_args_info_help[20] ;
  args_info->memmap_help = gengetopt_args_info_help[21] ;
  args_info->threads_help = gengetopt_args_info_help[22] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVw:c:n:o:d:s:g:b:Z:p:a:y:lxmt:v:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'w':	/* Answer file.  */
          ...
          break;
        case 'c':	/* Directory containing count files.  */

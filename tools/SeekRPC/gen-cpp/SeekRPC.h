...
class SeekRPCIf {
 public:
  ...
  virtual void seek_get_result(QueryResult& _return, const int64_t task_id, const bool block) = 0;
  virtual bool is_query_complete(const int64_t task_id) = 0;
  virtual void get_progress_message(std::string& _return, const int64_t task_id) = 0;
  virtual int32_t get_rpc_version() = 0;
...
typedef struct _SeekRPC_seek_get_result_args__isset {
  _SeekRPC_seek_get_result_args__isset() : task_id(false), block(true) {}
  bool task_id :1;
  bool block :1;
...
class SeekRPC_seek_get_result_args {
 public:
  ...
  SeekRPC_seek_get_result_args() : task_id(0), block(true) {
  }
...
typedef struct _SeekRPC_is_query_complete_args__isset {
  _SeekRPC_is_query_complete_args__isset() : task_id(false) {}
  bool task_id :1;
} _SeekRPC_is_query_complete_args__isset;

class SeekRPC_is_query_complete_args {
 public:

  SeekRPC_is_query_complete_args(const SeekRPC_is_query_complete_args&);
  SeekRPC_is_query_complete_args& operator=(const SeekRPC_is_query_complete_args&);
  SeekRPC_is_query_complete_args() : task_id(0) {
  }

  virtual ~SeekRPC_is_query_complete_args() noexcept;
  int64_t task_id;

  _SeekRPC_is_query_complete_args__isset __isset;

  void __set_task_id(const int64_t val);

  bool operator == (const SeekRPC_is_query_complete_args & rhs) const
  {
    if (!(task_id == rhs.task_id))
      return false;
    return true;
  ...
  bool operator < (const SeekRPC_is_query_complete_args & ) const;
...
class SeekRPC_is_query_complete_pargs {
 public:


  virtual ~SeekRPC_is_query_complete_pargs() noexcept;
  const int64_t* task_id;
...
typedef struct _SeekRPC_is_query_complete_result__isset {
  _SeekRPC_is_query_complete_result__isset() : success(false) {}
  bool success :1;
} _SeekRPC_is_query_complete_result__isset;

class SeekRPC_is_query_complete_result {
 public:

  SeekRPC_is_query_complete_result(const SeekRPC_is_query_complete_result&);
  SeekRPC_is_query_complete_result& operator=(const SeekRPC_is_query_complete_result&);
  SeekRPC_is_query_complete_result() : success(0) {
  }

  virtual ~SeekRPC_is_query_complete_result() noexcept;
  bool success;

  _SeekRPC_is_query_complete_result__isset __isset;

  void __set_success(const bool val);

  bool operator == (const SeekRPC_is_query_complete_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const SeekRPC_is_query_complete_result & ) const;
...
typedef struct _SeekRPC_is_query_complete_presult__isset {
  _SeekRPC_is_query_complete_presult__isset() : success(false) {}
  bool success :1;
} _SeekRPC_is_query_complete_presult__isset;

class SeekRPC_is_query_complete_presult {
 public:


  virtual ~SeekRPC_is_query_complete_presult() noexcept;
  bool* success;

  _SeekRPC_is_query_complete_presult__isset __isset;
...
class SeekRPC_get_rpc_version_args {
 public:

  SeekRPC_get_rpc_version_args(const SeekRPC_get_rpc_version_args&);
  SeekRPC_get_rpc_version_args& operator=(const SeekRPC_get_rpc_version_args&);
  SeekRPC_get_rpc_version_args() {
  }

  virtual ~SeekRPC_get_rpc_version_args() noexcept;

  bool operator == (const SeekRPC_get_rpc_version_args & /* rhs */) const
  {
    return true;
  }
  bool operator != (const SeekRPC_get_rpc_version_args &rhs) const {
  ...
  bool operator < (const SeekRPC_get_rpc_version_args & ) const;
...
class SeekRPC_get_rpc_version_pargs {
 public:


  virtual ~SeekRPC_get_rpc_version_pargs() noexcept;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _SeekRPC_get_rpc_version_result__isset {
  _SeekRPC_get_rpc_version_result__isset() : success(false) {}
  bool success :1;
} _SeekRPC_get_rpc_version_result__isset;

class SeekRPC_get_rpc_version_result {
 public:

  SeekRPC_get_rpc_version_result(const SeekRPC_get_rpc_version_result&);
  SeekRPC_get_rpc_version_result& operator=(const SeekRPC_get_rpc_version_result&);
  SeekRPC_get_rpc_version_result() : success(0) {
  }

  virtual ~SeekRPC_get_rpc_version_result() noexcept;
  int32_t success;

  _SeekRPC_get_rpc_version_result__isset __isset;

  void __set_success(const int32_t val);

  bool operator == (const SeekRPC_get_rpc_version_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const SeekRPC_get_rpc_version_result & ) const;
...
typedef struct _SeekRPC_get_rpc_version_presult__isset {
  _SeekRPC_get_rpc_version_presult__isset() : success(false) {}
  bool success :1;
} _SeekRPC_get_rpc_version_presult__isset;

class SeekRPC_get_rpc_version_presult {
 public:


  virtual ~SeekRPC_get_rpc_version_presult() noexcept;
  int32_t* success;

  _SeekRPC_get_rpc_version_presult__isset __isset;
...
class SeekRPCClient : virtual public SeekRPCIf {
 ...
 public:
  ...
  void seek_get_result(QueryResult& _return, const int64_t task_id, const bool block);
  void send_seek_get_result(const int64_t task_id, const bool block);
  void recv_seek_get_result(QueryResult& _return);
  bool is_query_complete(const int64_t task_id);
  void send_is_query_complete(const int64_t task_id);
  bool recv_is_query_complete();
  void get_progress_message(std::string& _return, const int64_t task_id);
  void send_get_progress_message(const int64_t task_id);
  void recv_get_progress_message(std::string& _return);
  int32_t get_rpc_version();
  void send_get_rpc_version();
  int32_t recv_get_rpc_version();
  int32_t ping();
  void send_ping();
  int32_t recv_ping();
  int32_t pvalue_genes();
...
class SeekRPCProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_is_query_complete(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  ...
  void process_get_rpc_version(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 ...
 public:
  SeekRPCProcessor(::std::shared_ptr<SeekRPCIf> iface) :
    ...
    processMap_["is_query_complete"] = &SeekRPCProcessor::process_is_query_complete;
    processMap_["get_progress_message"] = &SeekRPCProcessor::process_get_progress_message;
    processMap_["get_rpc_version"] = &SeekRPCProcessor::process_get_rpc_version;
...
class SeekRPCMultiface : virtual public SeekRPCIf {
 ...
 public:
  ...
  void seek_get_result(QueryResult& _return, const int64_t task_id, const bool block) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->seek_get_result(_return, task_id, block);
    }
    ifaces_[i]->seek_get_result(_return, task_id, block);
    return;
  }
  ...
  bool is_query_complete(const int64_t task_id) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->is_query_complete(task_id);
    }
    return ifaces_[i]->is_query_complete(task_id);
  }
  ...
  int32_t get_rpc_version() {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->get_rpc_version();
    }
    return ifaces_[i]->get_rpc_version();
  }
  ...
  SeekRPCConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  void seek_get_result(QueryResult& _return, const int64_t task_id, const bool block);
  int32_t send_seek_get_result(const int64_t task_id, const bool block);
  void recv_seek_get_result(QueryResult& _return, const int32_t seqid);
  bool is_query_complete(const int64_t task_id);
  int32_t send_is_query_complete(const int64_t task_id);
  bool recv_is_query_complete(const int32_t seqid);
  void get_progress_message(std::string& _return, const int64_t task_id);
  ...
  int32_t get_rpc_version();
  int32_t send_get_rpc_version();
  int32_t recv_get_rpc_version(const int32_t seqid);
  int32_t ping();
  int32_t send_ping();

...
class SeekQueryParams : public virtual ::apache::thrift::TBase {
 public:
  ...
  SeekQueryParams(const SeekQueryParams&);
  SeekQueryParams& operator=(const SeekQueryParams&);
  SeekQueryParams() : searchMethod((SearchMethod::type)1), distanceMeasure((DistanceMeasure::type)2), minQueryGenesFraction(0.0000000000000000), minGenomeFraction(0.0000000000000000), rbpParam(0.9900000000000000), useNegativeCorrelation(false), checkDatasetSize(false), useGeneSymbols(false), simulateWeights(false) {
...
class SeekQueryArgs : public virtual ::apache::thrift::TBase {
 public:
  ...
  SeekQueryArgs() : species("Unknown"), outputDir("/tmp/seek") {
  }
...
class SeekResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  SeekResult() : success(0), status((QueryStatus::type)0), statusMsg() {
  }
...
class PclResult : public virtual ::apache::thrift::TBase {
 public:
  ...
  PclResult() : success(0), status((QueryStatus::type)0), statusMsg() {
  }

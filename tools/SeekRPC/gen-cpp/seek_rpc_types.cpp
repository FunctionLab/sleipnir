    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->searchMethod = static_cast<SearchMethod::type>(ecast2);
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->distanceMeasure = static_cast<DistanceMeasure::type>(ecast3);
...
uint32_t SeekQueryParams::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.searchMethod) {
    ...
    xfer += oprot->writeI32(static_cast<int32_t>(this->searchMethod));
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.distanceMeasure) {
    xfer += oprot->writeFieldBegin("distanceMeasure", ::apache::thrift::protocol::T_I32, 2);
    xfer += oprot->writeI32(static_cast<int32_t>(this->distanceMeasure));
    xfer += oprot->writeFieldEnd();
  }
...
SeekQueryParams::SeekQueryParams(const SeekQueryParams& other4) noexcept {
...
SeekQueryParams& SeekQueryParams::operator=(const SeekQueryParams& other5) noexcept {
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->status = static_cast<QueryStatus::type>(ecast36);
...
PclSettings::PclSettings(const PclSettings& other41) noexcept {
...
PclSettings& PclSettings::operator=(const PclSettings& other42) noexcept {

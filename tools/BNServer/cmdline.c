/*
  ...
  /Genomics/Users/mark/sleipnir/extlib/gengetopt-2.22/src/gengetopt -iBNServer.ggo --default-optional -C -N -e 
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -w, --bn_priors=filename    Bayes net node priors",
  "\nOntologies:",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->bn_priors_arg = NULL;
  args_info->bn_priors_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->bn_priors_help = gengetopt_args_info_help[14] ;
  args_info->go_onto_help = gengetopt_args_info_help[16] ;
  args_info->go_anno_help = gengetopt_args_info_help[17] ;
  args_info->kegg_help = gengetopt_args_info_help[18] ;
  args_info->kegg_org_help = gengetopt_args_info_help[19] ;
  args_info->port_help = gengetopt_args_info_help[21] ;
  args_info->timeout_help = gengetopt_args_info_help[22] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->bn_priors_arg));
  free_string_field (&(args_info->bn_priors_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->bn_priors_given)
    write_into_file(outfile, "bn_priors", args_info->bn_priors_orig, 0);
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVd:i:c:a:s:n:b:xmM:w:g:G:k:K:p:t:f:z:C:v:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'M':	/* Store contexts and minimal Bayes nets.  */
          ...
          break;
        case 'w':	/* Bayes net node priors.  */
        
        
          if (update_arg( (void *)&(args_info->bn_priors_arg), 
               &(args_info->bn_priors_orig), &(args_info->bn_priors_given),
              &(local_args_info.bn_priors_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "bn_priors", 'w',
              additional_error))
            goto failure;

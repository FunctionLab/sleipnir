...
struct gengetopt_args_info
{
  ...
  char * table_arg;	/**< @brief Database table name (default='datapairs').  */
  char * table_orig;	/**< @brief Database table name original value given at command line.  */
  const char *table_help; /**< @brief Database table name help description.  */
  int datasets_flag;	/**< @brief Output datasets table (default=off).  */
  const char *datasets_help; /**< @brief Output datasets table help description.  */
  int block_arg;	/**< @brief Block size for SQL chunking (default='1000').  */
  char * block_orig;	/**< @brief Block size for SQL chunking original value given at command line.  */
  const char *block_help; /**< @brief Block size for SQL chunking help description.  */

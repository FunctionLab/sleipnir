/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe -u --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Txt2Bin\ -i ..\..\..\tools\Txt2Bin\Txt2Bin.ggo 
...
const char *gengetopt_args_info_purpose = "SVM binary input manipulator";

const char *gengetopt_args_info_usage = "Usage: Txt2Bin [OPTIONS]... [FILES]...";
...
char *cmdline_parser_from_values[] = {"txt", "dat", "bin", 0} ;	/* Possible values for from.  */
char *cmdline_parser_to_values[] = {"txt", "bin", 0} ;	/* Possible values for to.  */
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->from_arg));
  free_string_field (&(args_info->from_orig));
  free_string_field (&(args_info->to_arg));
  free_string_field (&(args_info->to_orig));
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* Source format.  */
          ...
          if (update_arg( (void *)&(args_info->from_arg), 
               &(args_info->from_orig), &(args_info->from_given),
              &(local_args_info.from_given), optarg, cmdline_parser_from_values, "txt", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "from", 'f',
              additional_error))
            goto failure;
        ...
        case 't':	/* Target format.  */
          ...
          if (update_arg( (void *)&(args_info->to_arg), 
               &(args_info->to_orig), &(args_info->to_given),

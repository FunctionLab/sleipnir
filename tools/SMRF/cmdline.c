/*
  ...
  /usr/bin/gengetopt -iSMRF.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_purpose = "Network models for SNP reranking";

const char *gengetopt_args_info_usage = "Usage: SMRF [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
        ...
        "\nMain:",
        "  -i, --graph=filename    Input graph DAT/DAB file",
        "  -I, --pvalues=filename  Input SNP PCL file",
        "\nParameters:",
        "  -t, --iterations=INT    Inference iterations per node  (default=`1000')",
        "  -e, --epsilon=DOUBLE    Minimum value  (default=`1e-6')",
        "  -n, --neighbors=DOUBLE  Fraction of neighbors to sample  (default=`1')",
        "\nOptional:",
...
void clear_args(struct gengetopt_args_info *args_info) {
    ...
    args_info->graph_arg = NULL;
    args_info->graph_orig = NULL;
    args_info->pvalues_arg = NULL;
    args_info->pvalues_orig = NULL;
    args_info->iterations_arg = 1000;
    args_info->iterations_orig = NULL;
    args_info->epsilon_arg = 1e-6;
...
void init_args_info(struct gengetopt_args_info *args_info) {
    ...
    args_info->graph_help = gengetopt_args_info_help[3];
    args_info->pvalues_help = gengetopt_args_info_help[4];
    args_info->iterations_help = gengetopt_args_info_help[6];
    args_info->epsilon_help = gengetopt_args_info_help[7];
...
cmdline_parser_release(struct gengetopt_args_info *args_info) {
    unsigned int i;
    free_string_field(&(args_info->graph_arg));
    free_string_field(&(args_info->graph_orig));
    free_string_field(&(args_info->pvalues_arg));
    free_string_field(&(args_info->pvalues_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info) {
    ...
    if (args_info->graph_given)
        write_into_file(outfile, "graph", args_info->graph_orig, 0);
    if (args_info->pvalues_given)
        write_into_file(outfile, "pvalues", args_info->pvalues_orig, 0);
...
cmdline_parser_required2(struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error) {
    ...
    if (!args_info->pvalues_given) {
        fprintf(stderr, "%s: '--pvalues' ('-I') option required%s\n", prog_name,
...
cmdline_parser_internal(
    ...
    while (1) {
        ...
        c = getopt_long(argc, argv, "hVi:I:t:e:n:ms:r:v:", long_options, &option_index);
        ...
        switch (c) {
            ...
            case 'V':    /* Print version and exit.  */
                ...
                break;
            case 'i':    /* Input graph DAT/DAB file.  */


                if (update_arg((void *) &(args_info->graph_arg),
                               &(args_info->graph_orig), &(args_info->graph_given),
                               &(local_args_info.graph_given), optarg, 0, 0, ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "graph", 'i',
                               additional_error))
                    goto failure;
                ...
                break;
            case 'I':    /* Input SNP PCL file.  */


                if (update_arg((void *) &(args_info->pvalues_arg),
                               &(args_info->pvalues_orig), &(args_info->pvalues_given),
                               &(local_args_info.pvalues_given), optarg, 0, 0, ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "pvalues", 'I',
                               additional_error))
                    goto failure;

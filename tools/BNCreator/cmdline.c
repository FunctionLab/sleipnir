/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe -u --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\BNCreator\ -i ..\..\..\tools\BNCreator\BNCreator.ggo 
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVw:i:o:d:g:G:c:C:b:zZ:ms:et:uv:", long_options, &option_index);

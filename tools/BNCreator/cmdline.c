/*
  ...
  ..\gengetopt-2.13.1\Release\gengetopt.exe -u -N -e -i BNCreator.ggo 
...
cmdline_parser_print_help (void)
{
  ...
  printf("%s\n","  -t, --terms=directory      Term inclusion directory");
...
cmdline_parser_free (struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->terms_arg)
    {
      free (args_info->terms_arg); /* free previous argument */
      args_info->terms_arg = 0;
    }
  ...
  while (1)
    {
      ...
      stop_char = 0;
      c = getopt_long (argc, argv, "hVw:i:o:d:v:g:G:c:C:t:zZ:ub:ms:e", long_options, &option_index);
      ...
      switch (c)
        ...
        case 't':	/* Term inclusion directory.  */
          if (local_args_info.terms_given)
            {
              fprintf (stderr, "%s: `--terms' (`-t') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
          if (args_info->terms_given && ! override)
            continue;
          local_args_info.terms_given = 1;
          args_info->terms_given = 1;
          if (args_info->terms_arg)
            free (args_info->terms_arg); /* free previous string */
          args_info->terms_arg = gengetopt_strdup (optarg);
          break;
        ...
        case 'e':	/* Convert PCL correlations to z-scores.  */
          if (local_args_info.zscore_given)
            {
              fprintf (stderr, "%s: `--zscore' (`-e') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }

...
#define CMDLINE_PARSER_PACKAGE "NetMiner"
#endif
...
struct gengetopt_args_info
{
  ...
  char * input_arg;	/**< @brief Input gene PCL file.  */
  char * input_orig;	/**< @brief Input gene PCL file original value given at command line.  */
  const char *input_help; /**< @brief Input gene PCL file help description.  */
  ...
  char * query_arg;	/**< @brief Input gene query file.  */
  char * query_orig;	/**< @brief Input gene query file original value given at command line.  */
  const char *query_help; /**< @brief Input gene query file help description.  */
  char * sim_arg;	/**< @brief Input gene similarity DAT/DAB file.  */
  char * sim_orig;	/**< @brief Input gene similarity DAT/DAB file original value given at command line.  */
  const char *sim_help; /**< @brief Input gene similarity DAT/DAB file help description.  */
  char * tissue_arg;	/**< @brief Input tissue expression PCL file.  */
  char * tissue_orig;	/**< @brief Input tissue expression PCL file original value given at command line.  */

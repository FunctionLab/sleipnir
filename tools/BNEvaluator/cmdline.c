/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\BNEvaluator\ -i ..\..\..\tools\BNEvaluator\BNEvaluator.ggo 
...
const char *gengetopt_args_info_purpose = "Per-gene whole Bayes net evaluation";

const char *gengetopt_args_info_usage = "Usage: BNEvaluator [OPTIONS]...";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->zero_help = gengetopt_args_info_help[11] ;
  args_info->pnl_help = gengetopt_args_info_help[13] ;
  args_info->function_help = gengetopt_args_info_help[14] ;
  args_info->algorithm_help = gengetopt_args_info_help[16] ;
  args_info->group_help = gengetopt_args_info_help[17] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:d:o:s:g:G:zpfa:uv:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* Bayesian inference algorithm.  */
          ...
          if (update_arg( (void *)&(args_info->algorithm_arg), 
              ...
              &(local_args_info.algorithm_given), optarg, 0, "0", ARG_INT,
              check_ambiguity, override, 0, 0,
              "algorithm", 'a',
              additional_error))
            goto failure;

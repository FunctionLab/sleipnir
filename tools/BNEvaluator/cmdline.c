/*
  ...
  ../gengetopt-2.13.1/bin/gengetopt -N -e -i BNEvaluator.ggo 
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n%s\n", "Per-gene whole Bayes net evaluation");
  printf("\nUsage: BNEvaluator [OPTIONS]...\n\n");
  printf("%s\n","  -h, --help             Print help and exit");
  printf("%s\n","  -V, --version          Print version and exit");
  printf("%s\n","  -i, --input=filename   Input DSL file");
  printf("%s\n","  -d, --data=filename    Input PCL file");
  printf("%s\n","\nOptional:");
  ...
  printf("%s\n","  -a, --algorithm=INT    Bayesian inference algorithm  (default=`0')");
  ...
  while (1)
    {
      ...
      stop_char = 0;
      c = getopt_long (argc, argv, "hVi:d:o:v:fpg:G:zus:a:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* Bayesian inference algorithm.  */
          if (local_args_info.algorithm_given)
            {
              fprintf (stderr, "%s: `--algorithm' (`-a') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
          if (args_info->algorithm_given && ! override)
            continue;
          local_args_info.algorithm_given = 1;

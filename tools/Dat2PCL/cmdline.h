...
#define CMDLINE_PARSER_PACKAGE "Dat2PCL"
#endif
...
struct gengetopt_args_info
{
  ...
  char * input_arg;	/**< @brief Input DAT file.  */
  char * input_orig;	/**< @brief Input DAT file original value given at command line.  */
  const char *input_help; /**< @brief Input DAT file help description.  */

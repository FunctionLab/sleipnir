...
struct gengetopt_args_info
{
  ...
  char * input_arg;	/**< @brief Input cluster file.  */
  char * input_orig;	/**< @brief Input cluster file original value given at command line.  */
  const char *input_help; /**< @brief Input cluster file help description.  */
  ...
  char * type_arg;	/**< @brief Type of input cluster (default='list').  */
  char * type_orig;	/**< @brief Type of input cluster original value given at command line.  */

/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Clusters2Dab\ -i ..\..\..\tools\Clusters2Dab\Clusters2Dab.ggo 
...
const char *gengetopt_args_info_usage = "Usage: Clusters2Dab [OPTIONS]...";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->skip_help = gengetopt_args_info_help[8] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:t:cs:v:", long_options, &option_index);

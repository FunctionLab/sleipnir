...
const char *gengetopt_args_info_purpose = "Generate pairwise scores from preclustered output.";

const char *gengetopt_args_info_usage = "Usage: Clusters2Dab [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
        ...
        "\nMain:",
        "  -i, --input=filename   Input cluster file",
        "  -o, --output=filename  Output DAT/DAB file",
        "  -t, --type=STRING      Type of input cluster  (possible values=\"samba\", \n                           \"list\", \"param\", \"fuzzy\" default=`list')",
        "\nOptional:",
        "  -c, --counts           Calculate pair weight by cocluster frequency  \n                           (default=off)",
        "  -z, --size             Calculate pair weight by cluster size  (default=off)",
...
char *cmdline_parser_type_values[] = {"samba", "list", "param", "fuzzy", 0};    /* Possible values for type.  */
...
void clear_args(struct gengetopt_args_info *args_info) {
    ...
    args_info->type_arg = gengetopt_strdup("list");
    args_info->type_orig = NULL;
    args_info->counts_flag = 0;
    args_info->size_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info) {
    ...
    args_info->counts_help = gengetopt_args_info_help[7];
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info) {
    ...
    if (args_info->size_given)
        write_into_file(outfile, "size", 0, 0);
...
cmdline_parser_internal(int argc, char *const *argv, struct gengetopt_args_info *args_info,
    ...
    while (1) {
        ...
        c = getopt_long(argc, argv, "hVi:o:t:czs:v:", long_options, &option_index);
        ...
        switch (c) {
            ...
            case 'o':    /* Output DAT/DAB file.  */
                ...
                break;
            case 't':    /* Type of input cluster.  */


                if (update_arg((void *) &(args_info->type_arg),
                               &(args_info->type_orig), &(args_info->type_given),
                               &(local_args_info.type_given), optarg, cmdline_parser_type_values, "list", ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "type", 't',
                               additional_error))
                    goto failure;
                ...
                break;
            case 'c':    /* Calculate pair weight by cocluster frequency.  */


                if (update_arg((void *) &(args_info->counts_flag), 0, &(args_info->counts_given),
                               &(local_args_info.counts_given), optarg, 0, 0, ARG_FLAG,
                               check_ambiguity, override, 1, 0, "counts", 'c',
                               additional_error))
                    goto failure;

                break;
            case 'z':    /* Calculate pair weight by cluster size.  */


                if (update_arg((void *) &(args_info->size_flag), 0, &(args_info->size_given),
                               &(local_args_info.size_given), optarg, 0, 0, ARG_FLAG,
                               check_ambiguity, override, 1, 0, "size", 'z',
                               additional_error))
                    goto failure;

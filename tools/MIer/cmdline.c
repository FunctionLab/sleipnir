/*
  ...
  /Genomics/Users/mark/sleipnir/extlib/gengetopt-2.22/src/gengetopt -iMIer.ggo --default-optional -u -N -e 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->table_help = gengetopt_args_info_help[9] ;
  args_info->only_help = gengetopt_args_info_help[10] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVd:zZ:Rty:mr:v:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'd':	/* Similarity measure.  */
          ...
          if (update_arg( (void *)&(args_info->distance_arg), 
              ...
              &(local_args_info.distance_given), optarg, cmdline_parser_distance_values, "mi", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "distance", 'd',
              additional_error))
            goto failure;

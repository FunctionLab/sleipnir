/*
  ...
  ..\..\..\..\extlib\proj\vs2008\release\gengetopt.exe -u --default-optional -N -e --output-dir=c:\Documents and Settings\CHUTTENH\My Documents\Visual Studio 2008\Projects\sleipnir\trunk\tools\MIer\ -i ..\..\..\tools\MIer\MIer.ggo 
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVd:zZ:Rs:ty:mr:v:", long_options, &option_index);

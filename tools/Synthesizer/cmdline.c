/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Synthesizer\ -i ..\..\..\tools\Synthesizer\Synthesizer.ggo 
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->tf_types_arg = gengetopt_strdup ("5");
      ...
      switch (c)
        ...
        case 'y':	/* Sequence types containing TFBSs, comma separated.  */
          ...
          if (update_arg( (void *)&(args_info->tf_types_arg), 
              ...
              &(local_args_info.tf_types_given), optarg, 0, "5", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "tf_types", 'y',
              additional_error))
            goto failure;

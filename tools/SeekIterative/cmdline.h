...
struct gengetopt_args_info
{
  ...
  char * dab_list_arg;	/**< @brief DAB/TDAB list.  */
  char * dab_list_orig;	/**< @brief DAB/TDAB list original value given at command line.  */
  const char *dab_list_help; /**< @brief DAB/TDAB list help description.  */
  ...
  int output_component_flag;	/**< @brief Output the search results in components, to be used for merging later. Good for handling results in distributed search. Writes results in *.gscore_comp files. Available for --tdab, --dab modes. (default=off).  */
  const char *output_component_help; /**< @brief Output the search results in components, to be used for merging later. Good for handling results in distributed search. Writes results in *.gscore_comp files. Available for --tdab, --dab modes. help description.  */
  int merge_component_flag;	/**< @brief Merge component, bypass search, just merge component outputs. Good for merging results in distributed search. Requires --merge_gscore_list. Available for --tdab, --dab modes. (default=off).  */
  const char *merge_component_help; /**< @brief Merge component, bypass search, just merge component outputs. Good for merging results in distributed search. Requires --merge_gscore_list. Available for --tdab, --dab modes. help description.  */
  char * merge_gscore_list_arg;	/**< @brief Merge gscore list. A list of filenames *.gscore_comp with path (default='NA').  */
  char * merge_gscore_list_orig;	/**< @brief Merge gscore list. A list of filenames *.gscore_comp with path original value given at command line.  */
  const char *merge_gscore_list_help; /**< @brief Merge gscore list. A list of filenames *.gscore_comp with path help description.  */

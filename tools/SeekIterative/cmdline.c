...
const char *cmdline_parser_tsearch_mode_values[] = {"eq", "cv_loi", "spell", "NA",
                                                    0}; /*< Possible values for tsearch_mode. */
...
cmdline_parser_internal(
    ...
    while (1) {
        ...
        c = getopt_long(argc, argv, "jdefghvb:t:EPc:G:J:a:V:I:T:R:M:H:n:N:i:q:F:Q:Z:Y:S:xD:", long_options,
                        &option_index);
        ...
        switch (c) {
            ...
            case 'S':    /* Search mode: equal weighted (eq) or CV LOI (cv_loi) or SPELL (spell) (Applicable if DAB list contains more than 1 dataset). (Required for --tdab and --dab modes).  */
                ...
                if (update_arg((void *) &(args_info->tsearch_mode_arg),
                               ...
                               &(local_args_info.tsearch_mode_given), optarg, cmdline_parser_tsearch_mode_values, "NA",
                               ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "tsearch_mode", 'S',
                               additional_error))

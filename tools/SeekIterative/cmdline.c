...
const char *gengetopt_args_info_help[] = {
  ...
  "\nTraditional DAB mode (see also: -Z, -Y. requires -S, -V, -F):",
  "  -a, --gavg_dir=directory      Gene average directory (.gavg files)  \n                                  (default=`NA')",
  "\nSparse DAB mode (see also: -Z, -Y. requires -S, -V, -F):",
  ...
  "  -V, --dab_list=filename       DAB/TDAB list",
  "\nOptions:",
  ...
  "  -o, --output_component        Output the search results in components, to be \n                                  used for merging later. Good for handling \n                                  results in distributed search. Writes results \n                                  in *.gscore_comp files. Available for --tdab, \n                                  --dab modes.  (default=off)",
  "  -O, --merge_component         Merge component, bypass search, just merge \n                                  component outputs. Good for merging results \n                                  in distributed search. Requires \n                                  --merge_gscore_list. Available for --tdab, \n                                  --dab modes.  (default=off)",
  "  -r, --merge_gscore_list=filename\n                                Merge gscore list. A list of filenames \n                                  *.gscore_comp with path  (default=`NA')",
  "\nOutput:",
...
char *cmdline_parser_tsearch_mode_values[] = {"eq", "cv_loi", "spell", "NA", 0} ;	/* Possible values for tsearch_mode.  */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->gavg_dir_help = gengetopt_args_info_help[19] ;
  args_info->num_iter_help = gengetopt_args_info_help[21] ;
  args_info->default_type_help = gengetopt_args_info_help[22] ;
  args_info->rbp_p_help = gengetopt_args_info_help[23] ;
  args_info->max_rank_help = gengetopt_args_info_help[24] ;
  args_info->dset_cutoff_file_help = gengetopt_args_info_help[25] ;
  args_info->norm_mode_help = gengetopt_args_info_help[26] ;
  args_info->exp_help = gengetopt_args_info_help[27] ;
  args_info->input_help = gengetopt_args_info_help[29] ;
  args_info->query_help = gengetopt_args_info_help[30] ;
  args_info->dab_dir_help = gengetopt_args_info_help[31] ;
  args_info->dab_list_help = gengetopt_args_info_help[32] ;
  ...
  args_info->output_component_help = gengetopt_args_info_help[40] ;
  args_info->merge_component_help = gengetopt_args_info_help[41] ;
  args_info->merge_gscore_list_help = gengetopt_args_info_help[42] ;
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "debug",	0, NULL, 'x' },
        { "output_component",	0, NULL, 'o' },
        { "merge_component",	0, NULL, 'O' },
        { "merge_gscore_list",	1, NULL, 'r' },
        { "dir_out",	1, NULL, 'D' },
        { NULL,	0, NULL, 0 }
      };

      c = getopt_long (argc, argv, "jdefghvb:t:EPc:G:a:I:T:R:M:H:n:N:i:q:F:V:Q:Z:Y:S:xoOr:D:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'x':	/* Debug mode.  */
          ...
          break;
        case 'o':	/* Output the search results in components, to be used for merging later. Good for handling results in distributed search. Writes results in *.gscore_comp files. Available for --tdab, --dab modes..  */
          ...
          if (update_arg((void *)&(args_info->output_component_flag), 0, &(args_info->output_component_given),
              ...
              check_ambiguity, override, 1, 0, "output_component", 'o',
              additional_error))
            goto failure;
        
          break;
        case 'O':	/* Merge component, bypass search, just merge component outputs. Good for merging results in distributed search. Requires --merge_gscore_list. Available for --tdab, --dab modes..  */
          ...
          if (update_arg((void *)&(args_info->merge_component_flag), 0, &(args_info->merge_component_given),
              ...
              check_ambiguity, override, 1, 0, "merge_component", 'O',
              additional_error))
            goto failure;
        
          break;
        case 'r':	/* Merge gscore list. A list of filenames *.gscore_comp with path.  */

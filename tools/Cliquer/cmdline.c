/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Cliquer\ -i ..\..\..\tools\Cliquer\Cliquer.ggo 
...
const char *gengetopt_args_info_purpose = "Find heavy subgraphs in a DAT graph";

const char *gengetopt_args_info_usage = "Usage: Cliquer [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -w, --heavy=DOUBLE        Final/initial specificity ratio for heavy subgraphs \n                               (default=`0.5')",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->heavy_help = gengetopt_args_info_help[4] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'i':	/* Input DAT/DAB file.  */
          ...
          break;
        case 'w':	/* Final/initial specificity ratio for heavy subgraphs.  */
        ...
        case 's':	/* Number of subgraphs to output.  */
          ...
          if (update_arg( (void *)&(args_info->subgraphs_arg), 
              ...
              &(local_args_info.subgraphs_given), optarg, 0, "100", ARG_INT,
              check_ambiguity, override, 0, 0,
              "subgraphs", 's',
              additional_error))
            goto failure;
        ...
        case 'S':	/* Size of subgraphs to find.  */
          ...
          if (update_arg( (void *)&(args_info->size_arg), 
              ...
              &(local_args_info.size_given), optarg, 0, "3", ARG_INT,
              check_ambiguity, override, 0, 0,
              "size", 'S',
              additional_error))
            goto failure;

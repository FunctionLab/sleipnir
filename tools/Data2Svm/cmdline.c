...
const char *gengetopt_args_info_usage = "Usage: Data2Svm [OPTIONS]... [FILES]...";
...
typedef enum {
    ARG_NO, ARG_FLAG, ARG_STRING, ARG_INT, ARG_FLOAT
        ...
        switch (c) {
            ...
            case 'k':    /* SVM kernel function.  */
                ...
                if (update_arg((void *) &(args_info->kernel_arg),
                               ...
                               &(local_args_info.kernel_given), optarg, cmdline_parser_kernel_values, "linear",
                               ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "kernel", 'k',
                               additional_error))

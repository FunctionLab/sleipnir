/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe -u --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Data2Bnt\ -i ..\..\..\tools\Data2Bnt\Data2Bnt.ggo 
...
const char *gengetopt_args_info_purpose = "BNT data file generation from data";

const char *gengetopt_args_info_usage = "Usage: Data2Bnt [OPTIONS]... [FILES]...";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->features_help = gengetopt_args_info_help[4] ;
  args_info->data_help = gengetopt_args_info_help[5] ;
  args_info->quants_help = gengetopt_args_info_help[6] ;
  args_info->genome_help = gengetopt_args_info_help[8] ;
  args_info->fraction_help = gengetopt_args_info_help[9] ;
  args_info->sparse_help = gengetopt_args_info_help[11] ;
  args_info->comments_help = gengetopt_args_info_help[12] ;
  args_info->xrff_help = gengetopt_args_info_help[13] ;
  args_info->weights_help = gengetopt_args_info_help[14] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->quants_arg));
  free_string_field (&(args_info->quants_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->quants_given)
    write_into_file(outfile, "quants", args_info->quants_orig, 0);
  ...
  if (args_info->xrff_given)
    write_into_file(outfile, "xrff", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:f:d:q:g:p:scxwv:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'q':	/* Quantization file for membership values.  */
          ...
          if (update_arg( (void *)&(args_info->quants_arg), 
               &(args_info->quants_orig), &(args_info->quants_given),
              &(local_args_info.quants_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "quants", 'q',
              additional_error))
            goto failure;
        ...
        case 's':	/* Output sparse matrix.  */
          ...
          if (update_arg((void *)&(args_info->sparse_flag), 0, &(args_info->sparse_given),
              ...
              check_ambiguity, override, 1, 0, "sparse", 's',
              additional_error))
            goto failure;
        ...
        case 'c':	/* Include informational comments.  */
          ...
          if (update_arg((void *)&(args_info->comments_flag), 0, &(args_info->comments_given),
              ...
              check_ambiguity, override, 1, 0, "comments", 'c',
              additional_error))
            goto failure;
        ...
        case 'x':	/* Generate XRFF formatted output.  */
          ...
          if (update_arg((void *)&(args_info->xrff_flag), 0, &(args_info->xrff_given),
              &(local_args_info.xrff_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "xrff", 'x',
              additional_error))
            goto failure;

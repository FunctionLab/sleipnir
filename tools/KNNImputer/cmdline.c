/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\KNNImputer\ -i ..\..\..\tools\KNNImputer\KNNImputer.ggo 
...
const char *gengetopt_args_info_purpose = "More modern version of KNNImpute.";

const char *gengetopt_args_info_usage = "Usage: KNNImputer [OPTIONS]...";
...
char *cmdline_parser_distance_values[] = {"pearson", "euclidean", "kendalls", "kolm-smir", "spearman", "pearnorm", "hypergeom", 0} ;	/* Possible values for distance.  */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->neighbors_help = gengetopt_args_info_help[6] ;
  args_info->distance_help = gengetopt_args_info_help[7] ;
  args_info->missing_help = gengetopt_args_info_help[8] ;
  args_info->genes_help = gengetopt_args_info_help[10] ;
  args_info->weights_help = gengetopt_args_info_help[11] ;
  args_info->autocorrelate_help = gengetopt_args_info_help[12] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->missing_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->missing_given)
    write_into_file(outfile, "missing", args_info->missing_orig, 0);
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:k:d:m:g:w:as:l:v:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'k':	/* Nearest neighbors to use.  */
          ...
          if (update_arg( (void *)&(args_info->neighbors_arg), 
              ...
              &(local_args_info.neighbors_given), optarg, 0, "10", ARG_INT,
              check_ambiguity, override, 0, 0,
              "neighbors", 'k',
              additional_error))
            goto failure;
        ...
        case 'd':	/* Similarity measure.  */
          ...
          if (update_arg( (void *)&(args_info->distance_arg), 
              ...
              &(local_args_info.distance_given), optarg, cmdline_parser_distance_values, "euclidean", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "distance", 'd',
              additional_error))
            goto failure;
        ...
        case 'm':	/* Fraction of conditions which must be present.  */
          ...
          if (update_arg( (void *)&(args_info->missing_arg), 
               &(args_info->missing_orig), &(args_info->missing_given),
              &(local_args_info.missing_given), optarg, 0, "0.7", ARG_DOUBLE,
              check_ambiguity, override, 0, 0,
              "missing", 'm',
              additional_error))
            goto failure;

/*
  ...
  /home/chuttenh/hg/sleipnir/trunk/../extlib/gengetopt-2.22/bin/gengetopt -iKNNImputer.ggo --default-optional -u -N -e 
...
char *cmdline_parser_distance_values[] = {"pearson", "euclidean", "kendalls", "kolm-smir", "spearman", "pearnorm",
                                          "hypergeom", 0};    /* Possible values for distance.  */
        ...
        switch (c) {
            ...
            case 'd':    /* Similarity measure.  */
                ...
                if (update_arg((void *) &(args_info->distance_arg),
                               ...
                               &(local_args_info.distance_given), optarg, cmdline_parser_distance_values, "euclidean",
                               ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "distance", 'd',
                               additional_error))

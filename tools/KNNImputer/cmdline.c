/*
  ...
  ../gengetopt-2.13.1/bin/gengetopt -N -e -i KNNImputer.ggo 
...
char *distance_values[] = {"pearson", "euclidean", "kendalls", "kolm-smir", "spearman", "pearnorm", "hypergeom", 0} ;	/* Possible values for distance.  */
...
void clear_args (struct gengetopt_args_info *args_info)
{
  args_info->neighbors_arg = 10 ;
  args_info->output_arg = NULL;
  args_info->distance_arg = gengetopt_strdup ("euclidean");
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n%s\n", "More modern version of KNNImpute.");
  printf("\nUsage: KNNImputer [OPTIONS]...\n\n");
  printf("%s\n","  -h, --help              Print help and exit");
  printf("%s\n","  -V, --version           Print version and exit");
  printf("%s\n","\nOptional:");
  printf("%s\n","  -k, --neighbors=INT     Nearest neighbors to use  (default=`10')");
  ...
  printf("%s\n","  -m, --missing=DOUBLE    Fraction of conditions which must be present  \n                            (default=`0.7')");
  ...
  while (1)
    {
      ...
      stop_char = 0;
      c = getopt_long (argc, argv, "hVk:o:d:s:i:w:ag:l:m:v:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'k':	/* Nearest neighbors to use.  */
        ...
        case 'l':	/* Gene count limit for caching.  */
          if (local_args_info.limit_given)
            {
              fprintf (stderr, "%s: `--limit' (`-l') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
          if (args_info->limit_given && ! override)
            continue;
          local_args_info.limit_given = 1;
          args_info->limit_given = 1;
          args_info->limit_arg = strtol (optarg,&stop_char,0);
          break;

        case 'm':	/* Fraction of conditions which must be present.  */
          if (local_args_info.missing_given)
            {
              fprintf (stderr, "%s: `--missing' (`-m') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
          if (args_info->missing_given && ! override)
            continue;
          local_args_info.missing_given = 1;
          args_info->missing_given = 1;
          args_info->missing_arg = strtod (optarg, NULL);
          break;

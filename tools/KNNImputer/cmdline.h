...
#define CMDLINE_PARSER_PACKAGE "KNNImputer"
#endif
...
struct gengetopt_args_info
{
  ...
  int neighbors_arg;	/**< @brief Nearest neighbors to use (default='10').  */
  char * neighbors_orig;	/**< @brief Nearest neighbors to use original value given at command line.  */
  const char *neighbors_help; /**< @brief Nearest neighbors to use help description.  */
  char * distance_arg;	/**< @brief Similarity measure (default='euclidean').  */
  ...
  double missing_arg;	/**< @brief Fraction of conditions which must be present (default='0.7').  */
  char * missing_orig;	/**< @brief Fraction of conditions which must be present original value given at command line.  */
  const char *missing_help; /**< @brief Fraction of conditions which must be present help description.  */
  ...
  unsigned int missing_given ;	/**< @brief Whether missing was given.  */

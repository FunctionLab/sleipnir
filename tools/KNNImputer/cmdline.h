...
{
  int neighbors_arg;	/* Nearest neighbors to use (default='10').  */
  char * output_arg;	/* Output PCL file.  */
  char * distance_arg;	/* Distance measure (default='euclidean').  */
  ...
  double missing_arg;	/* Fraction of conditions which must be present (default='0.7').  */
  ...
  int missing_given ;	/* Whether missing was given.  */

/*
  ...
  /home/chuttenh/hg/sleipnir/trunk/../extlib/gengetopt-2.22/bin/gengetopt -iRandomizer.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_usage = "Usage: Randomizer [OPTIONS]... [FILES]...";

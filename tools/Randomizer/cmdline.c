/*
  ...
  ../gengetopt-2.13.1/bin/gengetopt -N -e -i Randomizer.ggo 
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n%s\n", "Data file randomizer.");
  printf("\nUsage: Randomizer [OPTIONS]...\n\n");
  printf("%s\n","  -h, --help            Print help and exit");
  printf("%s\n","  -V, --version         Print version and exit");
  printf("%s\n","  -i, --input=filename  Input/output dat file");
  printf("%s\n","\nOptional:");
  ...
  while (1)
    {
      ...
      stop_char = 0;
      c = getopt_long (argc, argv, "hVi:c:v:r:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'c':	/* Target positive pair count.  */
          if (local_args_info.count_given)
            {
              fprintf (stderr, "%s: `--count' (`-c') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }

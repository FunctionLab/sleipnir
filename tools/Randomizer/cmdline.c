/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Randomizer\ -i ..\..\..\tools\Randomizer\Randomizer.ggo 
...
const char *gengetopt_args_info_purpose = "Data file randomizer.";

const char *gengetopt_args_info_usage = "Usage: Randomizer [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nMain:",
  "  -i, --input=filename  Input/output DAT/DAB file",
  "  -c, --count=INT       Target positive pair count  (default=`0')",
  "\nOptional:",
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:c:r:v:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'V':	/* Print version and exit.  */
          ...
          break;
        case 'i':	/* Input/output DAT/DAB file.  */
          ...
          break;
        case 'c':	/* Target positive pair count.  */

/*
  ...
  /r01/tergeo/chuttenh/sleipnir/trunk/../extlib/gengetopt-2.22/bin/gengetopt -iDSLConverter.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_usage = "Usage: DSLConverter [OPTIONS]... [FILES]...";

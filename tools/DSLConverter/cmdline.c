/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\DSLConverter\ -i ..\..\..\tools\DSLConverter\DSLConverter.ggo 
...
const char *gengetopt_args_info_purpose = "Interconverts DSL/XDSL files";

const char *gengetopt_args_info_usage = "Usage: DSLConverter [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -o, --output=filename  Output (X)DSL file",
  "\nOptional:",

...
#define CMDLINE_PARSER_PACKAGE "DSLConverter"
#endif
...
struct gengetopt_args_info
{
  ...
  char * output_arg;	/**< @brief Output (X)DSL file.  */
  char * output_orig;	/**< @brief Output (X)DSL file original value given at command line.  */
  const char *output_help; /**< @brief Output (X)DSL file help description.  */

/*
  ...
  /Genomics/Users/qzhu/usr4.9/bin/gengetopt -iDistancer.ggo --default-optional -u -N -e 
...
const char *cmdline_parser_distance_values[] = {"pearson", "euclidean", "kendalls", "kolm-smir", "spearman", "bicor", "pearnorm", "hypergeom", "innerprod", "bininnerprod", "quickpear", "mutinfo", "relauc", "pearsig", "dice", "dcor", "sdcor", 0}; /*< Possible values for distance. */

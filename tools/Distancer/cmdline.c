...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->distance_given)
    {
      fprintf (stderr, "%s: '--distance' ('-d') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  
  if (! args_info->weights_given)
    {
      fprintf (stderr, "%s: '--weights' ('-w') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  ...
  if (! args_info->cutoff_given)
    {
      fprintf (stderr, "%s: '--cutoff' ('-e') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  ...
  if (! args_info->limit_given)
    {
      fprintf (stderr, "%s: '--limit' ('-l') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:d:w:aqnzfg:e:A:s:l:v:t:", long_options, &option_index);

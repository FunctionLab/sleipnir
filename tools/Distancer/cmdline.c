/*
  ...
  ..\gengetopt-2.13.1\Release\gengetopt.exe -N -e -i Distancer.ggo 
...
char *distance_values[] = {"pearson", "euclidean", "kendalls", "kolm-smir", "spearman", "pearnorm", "hypergeom", "innerprod", "bininnerprod", "quickpear", "mi", "relauc", "pearsig", 0} ;	/* Possible values for distance.  */
  ...
  while (1)
    {
      ...
      stop_char = 0;
      c = getopt_long (argc, argv, "hVo:d:s:i:w:nazg:e:l:fv:", long_options, &option_index);

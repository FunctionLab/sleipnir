/*
  ...
  gengetopt --output-dir=tools/Distancer/ --default-optional 
...
const char *gengetopt_args_info_usage = "Usage: Distancer [OPTION]...";
...
const char *gengetopt_args_info_help[] = {
        ...
        "  -d, --distance=STRING   Similarity measure  (possible values=\"pearson\",\n                            \"euclidean\", \"kendalls\", \"kolm-smir\",\n                            \"spearman\", \"bicor\", \"pearnorm\",\n                            \"hypergeom\", \"innerprod\", \"bininnerprod\",\n                            \"quickpear\", \"mutinfo\", \"relauc\",\n                            \"pearsig\", \"dice\", \"dcor\", \"sdcor\",\n                            \"cosine\" default=`pearnorm')",
        "  -u, --quant=filename    Input Quant file",
        "\nMiscellaneous:",
...
typedef enum {
    ARG_NO, ARG_FLAG, ARG_STRING, ARG_INT, ARG_FLOAT, ARG_DOUBLE
...
const char *cmdline_parser_distance_values[] = {"pearson", "euclidean", "kendalls", "kolm-smir", "spearman", "bicor",
                                                "pearnorm", "hypergeom", "innerprod", "bininnerprod", "quickpear",
                                                "mutinfo", "relauc", "pearsig", "dice", "dcor", "sdcor", "cosine",
...
void init_args_info(struct gengetopt_args_info *args_info) {
    ...
    args_info->quant_help = gengetopt_args_info_help[6];
    args_info->weights_help = gengetopt_args_info_help[8];
    args_info->autocorrelate_help = gengetopt_args_info_help[9];
    args_info->freqweight_help = gengetopt_args_info_help[10];
    args_info->normalize_help = gengetopt_args_info_help[12];
    args_info->zscore_help = gengetopt_args_info_help[13];
    args_info->flip_help = gengetopt_args_info_help[14];
    args_info->centering_help = gengetopt_args_info_help[15];
    args_info->genes_help = gengetopt_args_info_help[17];
    args_info->cutoff_help = gengetopt_args_info_help[18];
    args_info->alpha_help = gengetopt_args_info_help[20];
    args_info->skip_help = gengetopt_args_info_help[21];
    args_info->limit_help = gengetopt_args_info_help[22];
    args_info->verbosity_help = gengetopt_args_info_help[23];
    args_info->threads_help = gengetopt_args_info_help[24];
...
cmdline_parser_internal(
    ...
    while (1) {
        ...
        c = getopt_long(argc, argv, "hVi:o:d:u:w:aqnzfcg:e:A:s:l:v:t:", long_options, &option_index);
        ...
        switch (c) {
            ...
            case 'd':    /* Similarity measure.  */
                ...
                if (update_arg((void *) &(args_info->distance_arg),
                               ...
                               &(local_args_info.distance_given), optarg, cmdline_parser_distance_values, "pearnorm",
                               ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "distance", 'd',
                               additional_error))

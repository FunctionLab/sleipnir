/*
  ...
  ..\..\..\..\extlib\proj\vs2008\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Distancer\ -i ..\..\..\tools\Distancer\Distancer.ggo 
...
const char *gengetopt_args_info_usage = "Usage: Distancer [OPTIONS]...";
...
char *cmdline_parser_distance_values[] = {"pearson", "euclidean", "kendalls", "kolm-smir", "spearman", "pearnorm", "hypergeom", "innerprod", "bininnerprod", "quickpear", "mi", "relauc", "pearsig", 0} ;	/* Possible values for distance.  */

/*
  ...
  /Genomics/Users/mark/sleipnir/extlib/gengetopt-2.22/src/gengetopt -iBNFunc.ggo --default-optional -C -N -e 
...
char *cmdline_parser_go_name_values[] = {"cc", "bp", "mf", 0} ;	/* Possible values for go_name.  */
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->go_name_given)
    write_into_file(outfile, "go_name", args_info->go_name_orig, cmdline_parser_go_name_values);
      ...
      switch (c)
        ...
        case 'n':	/* GO namespace.  */
          ...
          if (update_arg( (void *)&(args_info->go_name_arg), 
              ...
              &(local_args_info.go_name_given), optarg, cmdline_parser_go_name_values, "bp", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "go_name", 'n',
              additional_error))
            goto failure;

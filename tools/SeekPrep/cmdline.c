...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->quant_help = gengetopt_args_info_help[19] ;
  args_info->logit_help = gengetopt_args_info_help[21] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVdefsapB:vPb:I:A:NQ:li:D:", long_options, &option_index);

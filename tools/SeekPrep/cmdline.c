...
const char *gengetopt_args_info_usage = "Usage: SeekPrep [OPTION]... [FILE]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -m, --combineplat            Merges (combines) two platform wide gene average\n                                 and stdev files  (default=off)",
  ...
  "  -1, --in_dir1=filename       Input directory 1",
  "  -2, --in_dir2=filename       Input directory 2",
  "\nOutput:",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->datasetsize_given = 0 ;
  args_info->gplat_given = 0 ;
  args_info->combineplat_given = 0 ;
  ...
  args_info->in_dir1_given = 0 ;
  args_info->in_dir2_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->datasetsize_flag = 0;
  args_info->gplat_flag = 0;
  args_info->combineplat_flag = 0;
  ...
  args_info->in_dir1_arg = NULL;
  args_info->in_dir1_orig = NULL;
  args_info->in_dir2_arg = NULL;
  args_info->in_dir2_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->datasetsize_help = gengetopt_args_info_help[27] ;
  args_info->gplat_help = gengetopt_args_info_help[29] ;
  args_info->combineplat_help = gengetopt_args_info_help[30] ;
  args_info->dblist_help = gengetopt_args_info_help[31] ;
  args_info->dir_prep_in_help = gengetopt_args_info_help[32] ;
  args_info->dset_help = gengetopt_args_info_help[33] ;
  args_info->useNibble_help = gengetopt_args_info_help[34] ;
  args_info->quant_help = gengetopt_args_info_help[35] ;
  args_info->default_type_help = gengetopt_args_info_help[37] ;
  args_info->norm_mode_help = gengetopt_args_info_help[38] ;
  args_info->logit_help = gengetopt_args_info_help[39] ;
  args_info->max_rank_help = gengetopt_args_info_help[40] ;
  args_info->rbp_p_help = gengetopt_args_info_help[41] ;
  args_info->cutoff_value_help = gengetopt_args_info_help[42] ;
  args_info->exp_help = gengetopt_args_info_help[43] ;
  args_info->input_help = gengetopt_args_info_help[45] ;
  args_info->in_dir1_help = gengetopt_args_info_help[46] ;
  args_info->in_dir2_help = gengetopt_args_info_help[47] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->in_dir1_arg));
  free_string_field (&(args_info->in_dir1_orig));
  free_string_field (&(args_info->in_dir2_arg));
  free_string_field (&(args_info->in_dir2_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->datasetsize_given)
    write_into_file(outfile, "datasetsize", 0, 0 );
  if (args_info->gplat_given)
    write_into_file(outfile, "gplat", 0, 0 );
  if (args_info->combineplat_given)
    write_into_file(outfile, "combineplat", 0, 0 );
  ...
  if (args_info->in_dir1_given)
    write_into_file(outfile, "in_dir1", args_info->in_dir1_orig, 0);
  if (args_info->in_dir2_given)
    write_into_file(outfile, "in_dir2", args_info->in_dir2_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "sinfo",	0, NULL, 's' },
        { "datasetsize",	0, NULL, 'S' },
        { "gplat",	0, NULL, 'P' },
        { "combineplat",	0, NULL, 'm' },
        { "dblist",	1, NULL, 'b' },
      ...
      c = getopt_long (argc, argv, "defghH:J:G:L:O:W:apB:C:FXV:vsSPmb:I:A:NQ:T:n:lM:R:U:E:i:1:2:D:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'S':	/* Ouput dataset sizes and exit, i.e. number of experiments.  */
          ...
          if (update_arg((void *)&(args_info->datasetsize_flag), 0, &(args_info->datasetsize_given),
              &(local_args_info.datasetsize_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "datasetsize", 'S',
              additional_error))
            goto failure;
        ...
        case 'P':	/* Generates platform wide gene average and stdev file.  */
          ...
          break;
        case 'm':	/* Merges (combines) two platform wide gene average and stdev files.  */
        
        
          if (update_arg((void *)&(args_info->combineplat_flag), 0, &(args_info->combineplat_given),
              &(local_args_info.combineplat_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "combineplat", 'm',
              additional_error))
            goto failure;
        ...
        case 'i':	/* Gene mapping file.  */
          ...
          break;
        case '1':	/* Input directory 1.  */
        
        
          if (update_arg( (void *)&(args_info->in_dir1_arg), 
               &(args_info->in_dir1_orig), &(args_info->in_dir1_given),
              &(local_args_info.in_dir1_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "in_dir1", '1',
              additional_error))
            goto failure;
          ...
          break;
        case '2':	/* Input directory 2.  */
        
        
          if (update_arg( (void *)&(args_info->in_dir2_arg), 
               &(args_info->in_dir2_orig), &(args_info->in_dir2_given),
              &(local_args_info.in_dir2_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "in_dir2", '2',
              additional_error))
            goto failure;

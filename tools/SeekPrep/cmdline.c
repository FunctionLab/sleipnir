...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->pcl_list_help = gengetopt_args_info_help[11] ;
  args_info->pcl_dir_help = gengetopt_args_info_help[12] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hdefapB:V:F:vsPb:I:A:NQ:li:D:", long_options, &option_index);

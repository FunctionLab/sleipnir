...
struct gengetopt_args_info
{
  ...
  int combineplat_flag;	/**< @brief Merges (combines) two platform wide gene average and stdev files (default=off).  */
  const char *combineplat_help; /**< @brief Merges (combines) two platform wide gene average and stdev files help description.  */
  ...
  char * in_dir1_arg;	/**< @brief Input directory 1.  */
  char * in_dir1_orig;	/**< @brief Input directory 1 original value given at command line.  */
  const char *in_dir1_help; /**< @brief Input directory 1 help description.  */
  char * in_dir2_arg;	/**< @brief Input directory 2.  */
  char * in_dir2_orig;	/**< @brief Input directory 2 original value given at command line.  */
  const char *in_dir2_help; /**< @brief Input directory 2 help description.  */
  ...
  unsigned int datasetsize_given ;	/**< @brief Whether datasetsize was given.  */
  unsigned int gplat_given ;	/**< @brief Whether gplat was given.  */
  unsigned int combineplat_given ;	/**< @brief Whether combineplat was given.  */
  ...
  unsigned int in_dir1_given ;	/**< @brief Whether in_dir1 was given.  */
  unsigned int in_dir2_given ;	/**< @brief Whether in_dir2 was given.  */

...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->start_help = gengetopt_args_info_help[12] ;
  args_info->end_help = gengetopt_args_info_help[13] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:n:d:Z:l:mv:S:E:", long_options, &option_index);

/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Edges2Posteriors\ -i ..\..\..\tools\Edges2Posteriors\Edges2Posteriors.ggo 
...
const char *gengetopt_args_info_usage = "Usage: Edges2Posteriors [OPTIONS]...";
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:n:d:Z:l:mv:", long_options, &option_index);

/*
  ...
  /Genomics/ogtr03/cypark/sleipnir/../sleipnir-extlib/gengetopt-2.22/src/gengetopt -iEdges2Posteriors.ggo --default-optional -u -N -e 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->lookup_help = gengetopt_args_info_help[9] ;
  ...
  args_info->start_help = gengetopt_args_info_help[14] ;
  args_info->end_help = gengetopt_args_info_help[15] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:n:d:N:Z:l:c:mv:S:E:", long_options, &option_index);

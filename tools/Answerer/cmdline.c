...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->incident_help = gengetopt_args_info_help[10] ;
  args_info->exclude_help = gengetopt_args_info_help[11] ;
  args_info->scramble_help = gengetopt_args_info_help[12] ;
  args_info->overlap_help = gengetopt_args_info_help[14] ;
  args_info->genome_help = gengetopt_args_info_help[15] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVo:p:i:n:x:ce:s:l:g:t:r:v:", long_options, &option_index);

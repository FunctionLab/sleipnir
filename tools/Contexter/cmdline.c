/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Contexter\ -i ..\..\..\tools\Contexter\Contexter.ggo 
...
const char *gengetopt_args_info_usage = "Usage: Contexter [OPTIONS]...";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->lookup_help = gengetopt_args_info_help[17] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:td:c:e:g:n:b:xmM:l:pv:", long_options, &option_index);

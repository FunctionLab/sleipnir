/*
  ...
  /Genomics/Users/mark/sleipnir/extlib/gengetopt-2.22/src/gengetopt -iDat2Dab.ggo --default-optional -u -N -e 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->duplicates_help = gengetopt_args_info_help[14] ;
  args_info->genelist_help = gengetopt_args_info_help[15] ;
  ...
  args_info->remap_help = gengetopt_args_info_help[21] ;
  args_info->table_help = gengetopt_args_info_help[22] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:fnzrg:c:edGl:L:t:p:bs:mv:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'G':	/* Only list genes.  */
          ...
          if (update_arg((void *)&(args_info->genelist_flag), 0, &(args_info->genelist_given),
              ...
              check_ambiguity, override, 1, 0, "genelist", 'G',
              additional_error))
            goto failure;

...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->prior_given)
    {
      fprintf (stderr, "%s: '--prior' ('-k') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->newprior_given)
    {
      fprintf (stderr, "%s: '--newprior' ('-K') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  if (! args_info->genee_given)
    {
      fprintf (stderr, "%s: '--genee' ('-D') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->edges_given)
    {
      fprintf (stderr, "%s: '--edges' ('-e') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->exedges_given)
    {
      fprintf (stderr, "%s: '--exedges' ('-x') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->gexedges_given)
    {
      fprintf (stderr, "%s: '--gexedges' ('-X') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->cutoff_given)
    {
      fprintf (stderr, "%s: '--cutoff' ('-c') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->dval_given)
    {
      fprintf (stderr, "%s: '--dval' ('-V') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->dmissing_given)
    {
      fprintf (stderr, "%s: '--dmissing' ('-M') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->subsample_given)
    {
      fprintf (stderr, "%s: '--subsample' ('-u') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->lookup1_given)
    {
      fprintf (stderr, "%s: '--lookup1' ('-l') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->lookup2_given)
    {
      fprintf (stderr, "%s: '--lookup2' ('-L') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->lookups1_given)
    {
      fprintf (stderr, "%s: '--lookups1' ('-t') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->lookups2_given)
    {
      fprintf (stderr, "%s: '--lookups2' ('-T') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->remap_given)
    {
      fprintf (stderr, "%s: '--remap' ('-p') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->skip_given)
    {
      fprintf (stderr, "%s: '--skip' ('-s') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }

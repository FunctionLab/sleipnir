...
struct gengetopt_args_info
{
  ...
  char * genes_arg;	/**< @brief Process only genes from the given subset.  */
  char * genes_orig;	/**< @brief Process only genes from the given subset original value given at command line.  */
  const char *genes_help; /**< @brief Process only genes from the given subset help description.  */

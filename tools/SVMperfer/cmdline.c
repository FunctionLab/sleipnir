...
const char *gengetopt_args_info_purpose = "Wrapper for svm learning";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -a, --all                   Always calssify all genes in PCLs  (default=off)",
  ...
  "  -n, --normalize             Normalize PCLS to 0 mean 1 vairance  \n                                (default=off)",
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'm':	/* Model file.  */
          ...
          break;
        case 'a':	/* Always calssify all genes in PCLs.  */
        ...
        case 's':	/* Number of columns to skip in input pcls.  */
          ...
          break;
        case 'n':	/* Normalize PCLS to 0 mean 1 vairance.  */

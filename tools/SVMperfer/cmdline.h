...
struct gengetopt_args_info
{
  ...
  int all_flag;	/**< @brief Always calssify all genes in PCLs (default=off).  */
  const char *all_help; /**< @brief Always calssify all genes in PCLs help description.  */
  ...
  int normalize_flag;	/**< @brief Normalize PCLS to 0 mean 1 vairance (default=off).  */
  const char *normalize_help; /**< @brief Normalize PCLS to 0 mean 1 vairance help description.  */

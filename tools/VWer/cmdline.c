/*
  ...
  /home/chuttenh/hg/sleipnir/trunk/../extlib/gengetopt-2.22/bin/gengetopt -iVWer.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_purpose = "Vowpal Wabbit training and evaluation";

const char *gengetopt_args_info_usage = "Usage: VWer [OPTIONS]... [FILES]...";

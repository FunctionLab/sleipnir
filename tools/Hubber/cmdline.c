/*
  ...
  /Genomics/Users/mark/sleipnir/extlib/gengetopt-2.22/src/gengetopt -iHubber.ggo --default-optional -u -N -e 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->clip_help = gengetopt_args_info_help[7] ;
  args_info->output_help = gengetopt_args_info_help[9] ;
  args_info->contexts_help = gengetopt_args_info_help[10] ;
  args_info->genelist_help = gengetopt_args_info_help[11] ;
  args_info->directory_help = gengetopt_args_info_help[12] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:g:nc:o:x:s:d:mv:", long_options, &option_index);

/*
  ...
  /home/chuttenh/hg/sleipnir/trunk/../extlib/gengetopt-2.22/bin/gengetopt -iHubber.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_purpose = "Inspect a DAT/DAB file for gene network properties";

const char *gengetopt_args_info_usage = "Usage: Hubber [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
        ...
        "  -w, --weights=filename     Input weights PCL file",
        "\nMiscellaneous:",
        "  -n, --normalize            Normalize input file  (default=off)",
        "  -e, --genin=file           Gene inlusion list",
        "  -G, --genex=file           Gene exclusion list",
        ...
        "  -s, --genelist=filename    Genes for backgrounds/withins",
        "  -d, --directory=directory  Context network directory  (default=`.')",
        "  -t, --genesets=filename    Gene sets for within calculations",
        "  -b, --between=filename     Gene sets for between calculations",
        "\nOptional:",
        "  -a, --threads=INT          Number of simultaneous threads to use  \n                               (default=`1')",
...
void clear_args(struct gengetopt_args_info *args_info) {
    ...
    args_info->between_arg = NULL;
    args_info->between_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info) {
    ...
    args_info->genes_help = gengetopt_args_info_help[4];
    args_info->weights_help = gengetopt_args_info_help[5];
    args_info->normalize_help = gengetopt_args_info_help[7];
    args_info->genin_help = gengetopt_args_info_help[8];
    args_info->genex_help = gengetopt_args_info_help[9];
    args_info->clip_help = gengetopt_args_info_help[10];
    args_info->output_help = gengetopt_args_info_help[12];
    args_info->contexts_help = gengetopt_args_info_help[13];
    args_info->genelist_help = gengetopt_args_info_help[14];
    args_info->directory_help = gengetopt_args_info_help[15];
    args_info->genesets_help = gengetopt_args_info_help[16];
    args_info->between_help = gengetopt_args_info_help[17];
...
cmdline_parser_release(struct gengetopt_args_info *args_info) {
    ...
    free_string_field(&(args_info->genin_arg));
    free_string_field(&(args_info->genin_orig));
    free_string_field(&(args_info->genex_arg));
    free_string_field(&(args_info->genex_orig));
    free_string_field(&(args_info->clip_arg));
    free_string_field(&(args_info->clip_orig));
    free_string_field(&(args_info->output_arg));
    free_string_field(&(args_info->output_orig));
    free_string_field(&(args_info->contexts_arg));
    free_string_field(&(args_info->contexts_orig));
    free_string_field(&(args_info->genelist_arg));
    free_string_field(&(args_info->genelist_orig));
    ...
    free_string_field(&(args_info->between_arg));
    free_string_field(&(args_info->between_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info) {
    ...
    if (args_info->genin_given)
        write_into_file(outfile, "genin", args_info->genin_orig, 0);
    if (args_info->genex_given)
        write_into_file(outfile, "genex", args_info->genex_orig, 0);
    if (args_info->clip_given)
        write_into_file(outfile, "clip", args_info->clip_orig, 0);
    ...
    if (args_info->genelist_given)
        write_into_file(outfile, "genelist", args_info->genelist_orig, 0);
    ...
    if (args_info->between_given)
        write_into_file(outfile, "between", args_info->between_orig, 0);
...
cmdline_parser_internal(int argc, char *const *argv, struct gengetopt_args_info *args_info,
    ...
    while (1) {
        ...
        c = getopt_long(argc, argv, "hVi:g:w:ne:G:c:o:x:s:d:t:b:a:mv:", long_options, &option_index);
        ...
        switch (c) {
            ...
            case 'g':    /* Number of genes to output per gene set.  */
                ...
                if (update_arg((void *) &(args_info->genes_arg),
                               ...
                               &(local_args_info.genes_given), optarg, 0, "0", ARG_INT,
                               check_ambiguity, override, 0, 0,
                               "genes", 'g',
                               additional_error))
                    goto failure;
            ...
            case 'n':    /* Normalize input file.  */
                ...
                break;
            case 'e':    /* Gene inlusion list.  */


                if (update_arg((void *) &(args_info->genin_arg),
                               &(args_info->genin_orig), &(args_info->genin_given),
                               &(local_args_info.genin_given), optarg, 0, 0, ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "genin", 'e',
                               additional_error))
                    goto failure;
            ...
            case 'c':    /* Output directory to clip subnetworks for each gene set.  */
                ...
                if (update_arg((void *) &(args_info->clip_arg),
                               &(args_info->clip_orig), &(args_info->clip_given),
                               &(local_args_info.clip_given), optarg, 0, 0, ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "clip", 'c',
                               additional_error))
                    goto failure;
            ...
            case 'x':    /* Contexts for gene backgrounds.  */
                ...
                break;
            case 's':    /* Genes for backgrounds/withins.  */


                if (update_arg((void *) &(args_info->genelist_arg),
                               &(args_info->genelist_orig), &(args_info->genelist_given),
                               &(local_args_info.genelist_given), optarg, 0, 0, ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "genelist", 's',
                               additional_error))
                    goto failure;
            ...
            case 'd':    /* Context network directory.  */
                ...
                break;
            case 't':    /* Gene sets for within calculations.  */
                ...
                break;
            case 'b':    /* Gene sets for between calculations.  */


                if (update_arg((void *) &(args_info->between_arg),
                               &(args_info->between_orig), &(args_info->between_given),
                               &(local_args_info.between_given), optarg, 0, 0, ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "between", 'b',
                               additional_error))
                    goto failure;
                ...
                break;
            case 'a':    /* Number of simultaneous threads to use.  */

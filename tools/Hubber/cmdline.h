...
struct gengetopt_args_info
{
  ...
  char * output_arg;	/**< @brief Output gene backgrounds.  */
  char * output_orig;	/**< @brief Output gene backgrounds original value given at command line.  */
  const char *output_help; /**< @brief Output gene backgrounds help description.  */

...
char *cmdline_parser_distance_values[] = {"pearson", "quickpear", "euclidean", "kendalls", "kolm-smir", "hypergeom",
                                          "innerprod", "bininnerprod", "mi", 0};    /* Possible values for distance.  */
        ...
        switch (c) {
            ...
            case 'd':    /* Similarity measure.  */
                ...
                if (update_arg((void *) &(args_info->distance_arg),
                               ...
                               &(local_args_info.distance_given), optarg, cmdline_parser_distance_values, "kolm-smir",
                               ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "distance", 'd',
                               additional_error))

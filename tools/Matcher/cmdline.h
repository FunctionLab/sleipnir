...
#define CMDLINE_PARSER_PACKAGE "Matcher"
#endif
...
struct gengetopt_args_info {
    ...
    char *input_arg;    /**< @brief Directory with input DABs.  */
    char *input_orig;    /**< @brief Directory with input DABs original value given at command line.  */
    const char *input_help; /**< @brief Directory with input DABs help description.  */
    char *distance_arg;    /**< @brief Similarity measure (default='kolm-smir').  */
    ...
    int size_min_arg;    /**< @brief Minimum points to compare (default='0').  */
    char *size_min_orig;    /**< @brief Minimum points to compare original value given at command line.  */
    const char *size_min_help; /**< @brief Minimum points to compare help description.  */
    int size_max_arg;    /**< @brief Maximum points to compare (default='1000000000').  */
    char *size_max_orig;    /**< @brief Maximum points to compare original value given at command line.  */
    const char *size_max_help; /**< @brief Maximum points to compare help description.  */
    ...
    unsigned int size_min_given;    /**< @brief Whether size_min was given.  */
    unsigned int size_max_given;    /**< @brief Whether size_max was given.  */

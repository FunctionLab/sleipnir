...
cmdline_parser_internal(int argc, char *const *argv, struct gengetopt_args_info *args_info,
    ...
    while (1) {
        ...
        c = getopt_long(argc, argv,
                        "DAlWUCJkYBRgjz:S:T:t:a:c:e:u:bV:y:Z:K:L:f:m:E:n:M:F:G:H:h:I:Ox:X:i:q:d:p:r:s:NP:v:Q:o:",
        ...
        switch (c) {
            ...
            case 'O':    /* Order statistics mode (single-gene query).  */
                ...
                if (update_arg((void *) &(args_info->order_stat_single_gene_query_flag), 0,
                               &(args_info->order_stat_single_gene_query_given),

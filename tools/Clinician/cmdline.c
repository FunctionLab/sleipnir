/*
  ...
  /usr/bin/gengetopt -iClinician.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_purpose = "Calculates significance of clinical variables associated with genomewide \nexpression.";

const char *gengetopt_args_info_usage = "Usage: Clinician [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
        ...
        "  -I, --global=filename  Input DAT/DAB file",
        "\nMiscellaneous:",
        "  -n, --initial=INT      Initial correlated neighbor count  (default=`100')",
        "  -N, --final=INT        Final query result count  (default=`1000')",
        "  -a, --hefalmp          Perform HEFalMp query instead of bioPIXIE query  \n                           (default=on)",
        "  -p, --spearman         Use Spearman in place of Pearson correlation  \n                           (default=off)",
        "\nOptional:",
        "  -s, --skip=INT         Columns to skip in input PCL  (default=`1')",
...
void clear_args(struct gengetopt_args_info *args_info) {
    ...
    args_info->initial_arg = 100;
    args_info->initial_orig = NULL;
    args_info->final_arg = 1000;
    args_info->final_orig = NULL;
    args_info->hefalmp_flag = 1;
    args_info->spearman_flag = 0;
    args_info->skip_arg = 1;
...
void init_args_info(struct gengetopt_args_info *args_info) {
    ...
    args_info->global_help = gengetopt_args_info_help[4];
    args_info->initial_help = gengetopt_args_info_help[6];
    args_info->final_help = gengetopt_args_info_help[7];
    args_info->hefalmp_help = gengetopt_args_info_help[8];
    args_info->spearman_help = gengetopt_args_info_help[9];
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info) {
    ...
    if (args_info->spearman_given)
        write_into_file(outfile, "spearman", 0, 0);
...
cmdline_parser_internal(
    ...
    while (1) {
        ...
        c = getopt_long(argc, argv, "hVi:I:n:N:aps:mv:", long_options, &option_index);
        ...
        switch (c) {
            ...
            case 'I':    /* Input DAT/DAB file.  */
                ...
                break;
            case 'n':    /* Initial correlated neighbor count.  */


                if (update_arg((void *) &(args_info->initial_arg),
                               &(args_info->initial_orig), &(args_info->initial_given),
                               &(local_args_info.initial_given), optarg, 0, "100", ARG_INT,
                               check_ambiguity, override, 0, 0,
                               "initial", 'n',
                               additional_error))
                    goto failure;
                ...
                break;
            case 'N':    /* Final query result count.  */


                if (update_arg((void *) &(args_info->final_arg),
                               &(args_info->final_orig), &(args_info->final_given),
                               &(local_args_info.final_given), optarg, 0, "1000", ARG_INT,
                               check_ambiguity, override, 0, 0,
                               "final", 'N',
                               additional_error))
                    goto failure;
            ...
            case 'a':    /* Perform HEFalMp query instead of bioPIXIE query.  */
                ...
                break;
            case 'p':    /* Use Spearman in place of Pearson correlation.  */


                if (update_arg((void *) &(args_info->spearman_flag), 0, &(args_info->spearman_given),
                               &(local_args_info.spearman_given), optarg, 0, 0, ARG_FLAG,
                               check_ambiguity, override, 1, 0, "spearman", 'p',
                               additional_error))
                    goto failure;
            ...
            case 's':    /* Columns to skip in input PCL.  */
                ...
                if (update_arg((void *) &(args_info->skip_arg),
                               ...
                               &(local_args_info.skip_given), optarg, 0, "1", ARG_INT,
                               check_ambiguity, override, 0, 0,
                               "skip", 's',
                               additional_error))
                    goto failure;

/*
  ...
  /usr/bin/gengetopt -iFilterer.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_purpose = "Flexible DAT/DAB data filterer";

const char *gengetopt_args_info_usage = "Usage: Filterer [OPTIONS]... [FILES]...";
...
cmdline_parser_internal(
    ...
    while (1) {
        ...
        c = getopt_long(argc, argv, "hVi:o:mv:", long_options, &option_index);

/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe -u --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\DataDumper\ -i ..\..\..\tools\DataDumper\DataDumper.ggo 
...
const char *gengetopt_args_info_purpose = "Examination of data used for large scale Bayes net learning";

const char *gengetopt_args_info_usage = "Usage: DataDumper [OPTIONS]... [FILES]...";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->genex_help = gengetopt_args_info_help[6] ;
  args_info->genet_help = gengetopt_args_info_help[7] ;
  args_info->zero_help = gengetopt_args_info_help[9] ;
  args_info->zeros_help = gengetopt_args_info_help[10] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVw:g:G:c:zZ:v:", long_options, &option_index);

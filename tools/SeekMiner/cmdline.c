/*
  ...
  /r03/qzhu/usr/bin/gengetopt -iSeekMiner.ggo --default-optional -u -N -e 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->output_text_help = gengetopt_args_info_help[28] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVx:D:i:q:d:p:P:Q:n:w:f:W:R:F:lmMrc:C:Nb:O", long_options, &option_index);

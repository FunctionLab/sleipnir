...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->func_db_help = gengetopt_args_info_help[15] ;
  args_info->func_n_help = gengetopt_args_info_help[16] ;
  args_info->func_prep_help = gengetopt_args_info_help[17] ;
  args_info->func_quant_help = gengetopt_args_info_help[18] ;
  args_info->func_dset_help = gengetopt_args_info_help[19] ;
  args_info->func_logit_help = gengetopt_args_info_help[20] ;
  args_info->correlation_help = gengetopt_args_info_help[22] ;
  args_info->norm_subavg_help = gengetopt_args_info_help[23] ;
  args_info->norm_platsubavg_help = gengetopt_args_info_help[24] ;
  args_info->norm_platstdev_help = gengetopt_args_info_help[25] ;

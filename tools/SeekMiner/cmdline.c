...
char *cmdline_parser_weighting_method_values[] = {"CV", "EQUAL", "ORDER_STAT", "VAR", "USER", "AVERAGE_Z", "CV_CUSTOM",
                                                  0};    /* Possible values for weighting_method.  */
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info) {
    ...
    if (args_info->weighting_method_given)
        write_into_file(outfile, "weighting_method", args_info->weighting_method_orig,
                        cmdline_parser_weighting_method_values);
...
cmdline_parser_internal(int argc, char *const *argv, struct gengetopt_args_info *args_info,
    ...
    while (1) {
        ...
        c = getopt_long(argc, argv, "hx:D:i:q:d:p:P:u:U:Q:n:T:H:kLV:K:J:St:z:mMc:eC:I:X:G:R:Nb:Oo:YEB:", long_options,
                        &option_index);
        ...
        switch (c) {
            ...
            case 'V':    /* Weighting method: query cross-validated weighting (CV), equal weighting (EQUAL), order statistics weighting (ORDER_STAT), variance weighting (VAR), user-given weighting (USER), SPELL weighting (AVERAGE_Z), user cross-validated weighting (CV_CUSTOM).  */
                ...
                if (update_arg((void *) &(args_info->weighting_method_arg),
                               ...
                               &(local_args_info.weighting_method_given), optarg,
                               cmdline_parser_weighting_method_values, "CV", ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "weighting_method", 'V',
                               additional_error))
                    goto failure;
            ...
            case 'z':    /* Distance measure.  */
                ...
                if (update_arg((void *) &(args_info->dist_measure_arg),
                               ...
                               &(local_args_info.dist_measure_given), optarg, cmdline_parser_dist_measure_values,
                               "z_score", ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "dist_measure", 'z',
                               additional_error))
            ...
            case 'I':    /* The query partitioning method (for CV weighting): Leave-One-In, Leave-One-Out, X-Fold..  */
                ...
                if (update_arg((void *) &(args_info->CV_partition_arg),
                               ...
                               &(local_args_info.CV_partition_given), optarg, cmdline_parser_CV_partition_values, "LOI",
                               ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "CV_partition", 'I',
                               additional_error))

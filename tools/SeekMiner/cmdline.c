...
const char *gengetopt_args_info_help[] = {
  ...
  "\nDataset weighting:",
  "  -V, --CV                      Query-based weighting using cross-validations  \n                                  (default=off)",
  "  -E, --EQUAL                   Equal dataset weighting  (default=off)",
  "  -A, --ORDER_STAT              Order statistics weighting and integration  \n                                  (default=off)",
  ...
  "  -s, --rank_biased_precision_p=FLOAT\n                                Rank biased precision (RBP) p parameter if RBP \n                                  is the weighting method  (default=`0.99')",
  "\nMISC:",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->EQUAL_given = 0 ;
  args_info->ORDER_STAT_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->CV_flag = 0;
  args_info->EQUAL_flag = 0;
  args_info->ORDER_STAT_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->CV_help = gengetopt_args_info_help[15] ;
  args_info->EQUAL_help = gengetopt_args_info_help[16] ;
  args_info->ORDER_STAT_help = gengetopt_args_info_help[17] ;
  ...
  args_info->z_score_help = gengetopt_args_info_help[29] ;
  args_info->correlation_help = gengetopt_args_info_help[30] ;
  args_info->norm_subavg_help = gengetopt_args_info_help[31] ;
  args_info->norm_platsubavg_help = gengetopt_args_info_help[32] ;
  args_info->norm_platstdev_help = gengetopt_args_info_help[33] ;
  ...
  args_info->rank_biased_precision_p_help = gengetopt_args_info_help[38] ;
  args_info->is_nibble_help = gengetopt_args_info_help[40] ;
  args_info->buffer_help = gengetopt_args_info_help[41] ;
  args_info->output_text_help = gengetopt_args_info_help[42] ;
  args_info->output_dir_help = gengetopt_args_info_help[43] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->CV_given)
    write_into_file(outfile, "CV", 0, 0 );
  if (args_info->EQUAL_given)
    write_into_file(outfile, "EQUAL", 0, 0 );
  if (args_info->ORDER_STAT_given)
    write_into_file(outfile, "ORDER_STAT", 0, 0 );
  ...
  if (args_info->z_score_given)
    write_into_file(outfile, "z_score", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hx:D:i:q:d:p:P:u:U:Q:n:VEAw:f:W:R:F:lSt:zTmMrc:eC:s:Nb:Oo:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'n':	/* Number of databaselets in database.  */
          ...
          break;
        case 'V':	/* Query-based weighting using cross-validations.  */
        
        
          if (update_arg((void *)&(args_info->CV_flag), 0, &(args_info->CV_given),
              &(local_args_info.CV_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "CV", 'V',
              additional_error))
            goto failure;
        
          break;
        case 'E':	/* Equal dataset weighting.  */
        
        
          if (update_arg((void *)&(args_info->EQUAL_flag), 0, &(args_info->EQUAL_given),
              &(local_args_info.EQUAL_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "EQUAL", 'E',
              additional_error))
            goto failure;
        
          break;
        case 'A':	/* Order statistics weighting and integration.  */
        
        
          if (update_arg((void *)&(args_info->ORDER_STAT_flag), 0, &(args_info->ORDER_STAT_given),
              &(local_args_info.ORDER_STAT_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "ORDER_STAT", 'A',
              additional_error))
            goto failure;
        ...
        case 't':	/* Number of repetitions of generating random rankings.  */
          ...
          break;
        case 'z':	/* Per dataset, use z-scores of Pearson correlations.  */
        
        
          if (update_arg((void *)&(args_info->z_score_flag), 0, &(args_info->z_score_given),
              &(local_args_info.z_score_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "z_score", 'z',
              additional_error))
            goto failure;
        
          break;
        case 'T':	/* Per dataset, use Pearson correlations instead of z-scores. -m, -M, -r, -z do not apply. The sinfo directory (-u) must be given..  */
          ...
          break;
        case 'm':	/* Per dataset, normalize z-scores by subtracting average of result gene. Requires -z..  */
          ...
          break;
        case 'M':	/* Per platform, normalize z-scores by subtracting average of query gene across platform. Requires -z -m..  */
          ...
          break;
        case 'r':	/* Per platform, normalize z-scores by dividing stdev of query gene across platform. Requires -z -m -M..  */
        ...
        case 'c':	/* Cutoff on the gene-gene score before adding, default: no cutoff.  */
          ...
          break;
        case 'e':	/* If using z-score, square-transform z-scores. Usually used in conjunction with --score-cutoff. Requires -z..  */
        ...
        case 'C':	/* Fraction (max 1.0) of query required to correlate with a gene, in order to count the gene's query score. A gene may not correlate with a query gene if it is absent, or its correlation with query does not pass cut-off (specified by --score_cutoff). Use this with caution. Be careful if using with --score_cutoff..  */
          ...
          break;
        case 's':	/* Rank biased precision (RBP) p parameter if RBP is the weighting method.  */

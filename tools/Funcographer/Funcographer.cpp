...
void max_connectivity(const vector<bool> &, const vector <size_t> &, const vector<float> &,
                      const vector <size_t> &, float, size_t, float, size_t, size_t, const CDat &, float &, size_t &,
                      float &,
                      size_t &, float &, size_t &);
...
void output_datasets(const gengetopt_args_info &sArgs, const CDat &DatData, const CDat &DatFunctions,
                     const CPCL &PCLTrusts, const vector <size_t> &veciCluster,
                     const vector <size_t> &veciFunctions2Trusts) {

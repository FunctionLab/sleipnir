...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->include_list_help = gengetopt_args_info_help[40] ;
  args_info->dir_out_help = gengetopt_args_info_help[42] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVOMratcux:e:p:FWABCDEi:I:w:fs:g:q:y:n:S:G:Q:X:Y:d:", long_options, &option_index);

/*
  ...
  /r03/qzhu/usr/bin/gengetopt -iSeekEvaluator.ggo --default-optional -u -N -e 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->dislay_only_help = gengetopt_args_info_help[14] ;
  args_info->display_weight_help = gengetopt_args_info_help[15] ;
  args_info->agg_avg_help = gengetopt_args_info_help[17] ;
  args_info->agg_quartile_help = gengetopt_args_info_help[18] ;
  args_info->agg_ranksum_help = gengetopt_args_info_help[19] ;
  args_info->agg_scoresum_help = gengetopt_args_info_help[20] ;
  args_info->display_all_help = gengetopt_args_info_help[21] ;
  args_info->input_help = gengetopt_args_info_help[23] ;
  args_info->dataset_map_help = gengetopt_args_info_help[25] ;
  args_info->weight_help = gengetopt_args_info_help[26] ;
  args_info->goldstd_help = gengetopt_args_info_help[28] ;
  args_info->gscore_help = gengetopt_args_info_help[29] ;
  args_info->query_help = gengetopt_args_info_help[30] ;
  args_info->nan_help = gengetopt_args_info_help[31] ;
  args_info->goldstd_list_help = gengetopt_args_info_help[33] ;
  args_info->gscore_list_help = gengetopt_args_info_help[34] ;
  args_info->query_list_help = gengetopt_args_info_help[35] ;
  args_info->dir_out_help = gengetopt_args_info_help[37] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVOMratcux:e:p:FWABCDEi:I:w:s:g:q:n:S:G:Q:d:", long_options, &option_index);

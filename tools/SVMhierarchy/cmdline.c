/*
  ...
  /Genomics/grid/users/jzthree/bin/gengetopt -iSVMhierarchy.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_purpose = "Hierarchical Multilabel SVM powered by SVM-struct";

const char *gengetopt_args_info_usage = "Usage: SVMhierarchy [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -S, --slack                   Use slack rescaling (NOT implemented for \n                                  Hierarchical Multilabel SVM)  (default=off)",
  "\nOptions:",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->ontoparam_arg = NULL;
  args_info->ontoparam_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ontoparam_help = gengetopt_args_info_help[7] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->ontoparam_arg));
  free_string_field (&(args_info->ontoparam_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->ontoparam_given)
    write_into_file(outfile, "ontoparam", args_info->ontoparam_orig, 0);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'm':	/* Model file.  */
          ...
          break;
        case 'h':	/* Ontology file.  */
        
        
          if (update_arg( (void *)&(args_info->ontoparam_arg), 
               &(args_info->ontoparam_orig), &(args_info->ontoparam_given),
              &(local_args_info.ontoparam_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "ontoparam", 'h',
              additional_error))
            goto failure;
        ...
        case 'a':	/* Always classify all genes in PCLs.  */
          ...
          break;
        case 'S':	/* Use slack rescaling (NOT implemented for Hierarchical Multilabel SVM).  */

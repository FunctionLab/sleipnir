/*
  ...
  /r01/tergeo/chuttenh/sleipnir/trunk/../extlib/gengetopt-2.22/bin/gengetopt -iCOALESCE.ggo --default-optional -N -e 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->pvalue_merge_help = gengetopt_args_info_help[12] ;
  args_info->cutoff_merge_help = gengetopt_args_info_help[13] ;
  args_info->penalty_gap_help = gengetopt_args_info_help[14] ;
  args_info->penalty_mismatch_help = gengetopt_args_info_help[15] ;
  args_info->pvalue_correl_help = gengetopt_args_info_help[17] ;
  args_info->frac_correl_help = gengetopt_args_info_help[18] ;
  args_info->sequences_help = gengetopt_args_info_help[19] ;
  args_info->bases_help = gengetopt_args_info_help[20] ;
  args_info->size_minimum_help = gengetopt_args_info_help[21] ;
  args_info->size_maximum_help = gengetopt_args_info_help[22] ;
  args_info->intermediate_help = gengetopt_args_info_help[24] ;
  args_info->cache_help = gengetopt_args_info_help[25] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:f:d:p:P:m:k:g:G:y:Y:c:C:q:b:z:Z:t:e:s:r:v:", long_options, &option_index);

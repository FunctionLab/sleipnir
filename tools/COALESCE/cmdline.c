...
cmdline_parser_internal(int argc, char *const *argv, struct gengetopt_args_info *args_info,
    ...
    while (1) {
        ...
        c = getopt_long(argc, argv, "hVi:f:d:o:p:c:m:C:M:k:g:G:y:Y:n:N:q:b:z:E:Z:j:K:F:S:J:L:T:Ru:x:eOD:t:s:r:v:",
        ...
        switch (c) {
            ...
            case 'S':    /* Type of known motif matching.  */
                ...
                if (update_arg((void *) &(args_info->known_type_arg),
                               ...
                               &(local_args_info.known_type_given), optarg, cmdline_parser_known_type_values, "pvalue",
                               ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "known_type", 'S',
                               additional_error))

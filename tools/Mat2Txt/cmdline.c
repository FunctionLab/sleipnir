/*
  ...
  /home/chuttenh/hg/sleipnir/trunk/../extlib/gengetopt-2.22/bin/gengetopt -iMat2Txt.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_usage = "Usage: Mat2Txt [OPTIONS]... [FILES]...";

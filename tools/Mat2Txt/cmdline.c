/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Mat2Txt\ -i ..\..\..\tools\Mat2Txt\Mat2Txt.ggo 
...
const char *gengetopt_args_info_purpose = "Text/binary matrix file interconversion";

const char *gengetopt_args_info_usage = "Usage: Mat2Txt [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nMain:",
  "  -i, --input=filename   Input matrix file",
  "  -o, --output=filename  Output matrix file",
  "\nOptional:",

/*
  ...
  /usr/local/bin/gengetopt -iSeekPValue.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_usage = "Usage: SeekPValue [OPTION]... [FILE]...";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->dset_platform_help = gengetopt_args_info_help[5] ;
  args_info->input_help = gengetopt_args_info_help[6] ;
  args_info->param_dir_help = gengetopt_args_info_help[8] ;
      ...
      switch (c)
        ...
        case 'N':	/* Number of random trials.  */
          ...
          if (update_arg( (void *)&(args_info->random_num_arg), 
              ...
              &(local_args_info.random_num_given), optarg, 0, "-1", ARG_INT,
              check_ambiguity, override, 0, 0,
              "random_num", 'N',
              additional_error))
            goto failure;

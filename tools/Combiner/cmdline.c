...
char *cmdline_parser_method_values[] = {"min", "max", "mean", "gmean", "hmean", "sum", "diff", "meta", "qmeta", "prod",
                                        0};    /* Possible values for method.  */
        ...
        switch (c) {
            ...
            case 'm':    /* Combination method.  */
                ...
                if (update_arg((void *) &(args_info->method_arg),
                               ...
                               &(local_args_info.method_given), optarg, cmdline_parser_method_values, "mean",
                               ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "method", 'm',
                               additional_error))

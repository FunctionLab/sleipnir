/*
  ...
  gengetopt -iCombiner.ggo --default-optional -u -N -e 
...
const char *cmdline_parser_type_values[] = {"pcl", "dat", "dad", "module", "revdat", 0}; /*< Possible values for type. */
const char *cmdline_parser_method_values[] = {"min", "max", "mean", "gmean", "hmean", "sum", "diff", "meta", "qmeta", 0}; /*< Possible values for method. */

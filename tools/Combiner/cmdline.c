/*
  ...
  /Genomics/Users/mark/sleipnir/extlib/gengetopt-2.22/src/gengetopt -iCombiner.ggo --default-optional -u -N -e 
...
char *cmdline_parser_type_values[] = {"pcl", "dat", "dab", 0} ;	/* Possible values for type.  */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->memmap_help = gengetopt_args_info_help[8] ;
  args_info->normalize_help = gengetopt_args_info_help[9] ;
  args_info->subset_help = gengetopt_args_info_help[10] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVt:m:o:k:pns:v:", long_options, &option_index);

/*
  ...
  /Genomics/fgrid/function/sleipnir-extlib/gengetopt/src/gengetopt -iBNTruster.ggo --default-optional -u -N -e 
...
char *cmdline_parser_type_values[] = {"posteriors", "sums", "ratios", "wratios", 0};    /* Possible values for type.  */
        ...
        switch (c) {
            ...
            case 't':    /* Trust calculation type.  */
                ...
                if (update_arg((void *) &(args_info->type_arg),
                               ...
                               &(local_args_info.type_given), optarg, cmdline_parser_type_values, "posteriors",
                               ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "type", 't',
                               additional_error))

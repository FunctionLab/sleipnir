/*
  ...
  ..\gengetopt-2.13.1\Release\gengetopt.exe -u -N -e -i BNTruster.ggo 
...
char *type_values[] = {"posteriors", "sums", "ratios", 0} ;	/* Possible values for type.  */
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n%s\n", "Bayes net data set trust evaluation");
  printf("\nUsage: BNTruster [OPTIONS]... [FILES]...\n\n");
  ...
  while (1)
    {
      ...
      stop_char = 0;
      c = getopt_long (argc, argv, "hVt:bv:d:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'b':	/* Output individual bins.  */
          ...
          args_info->bins_flag = !(args_info->bins_flag);
          break;
        ...
        case 'd':	/* Number of simultaneous threads to use.  */
          if (local_args_info.threads_given)
            {
              fprintf (stderr, "%s: `--threads' (`-d') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }

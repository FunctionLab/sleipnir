/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe -u --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\BNTruster\ -i ..\..\..\tools\BNTruster\BNTruster.ggo 
...
const char *gengetopt_args_info_purpose = "Bayes net dataset functional activity evaluation";

const char *gengetopt_args_info_usage = "Usage: BNTruster [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nOptional:",
  "  -t, --type=STRING    Trust calculation type  (possible values=\"posteriors\", \n                         \"sums\", \"ratios\" default=`posteriors')",
  "  -b, --bins           Output individual bins  (default=off)",
  "  -d, --threads=INT    Number of simultaneous threads to use  (default=`1')",
...
char *cmdline_parser_type_values[] = {"posteriors", "sums", "ratios", 0} ;	/* Possible values for type.  */
...
void clear_args (struct gengetopt_args_info *args_info)
{
  args_info->type_arg = gengetopt_strdup ("posteriors");
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->bins_help = gengetopt_args_info_help[4] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVt:bd:v:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'V':	/* Print version and exit.  */
          ...
          break;
        case 't':	/* Trust calculation type.  */
        
        
          if (update_arg( (void *)&(args_info->type_arg), 
               &(args_info->type_orig), &(args_info->type_given),
              &(local_args_info.type_given), optarg, cmdline_parser_type_values, "posteriors", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "type", 't',
              additional_error))
            goto failure;
          ...
          break;
        case 'b':	/* Output individual bins.  */
        
        
          if (update_arg((void *)&(args_info->bins_flag), 0, &(args_info->bins_given),
              &(local_args_info.bins_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "bins", 'b',
              additional_error))
            goto failure;
        
          break;
        case 'd':	/* Number of simultaneous threads to use.  */

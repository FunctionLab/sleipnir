...
struct gengetopt_args_info
{
  ...
  char * type_arg;	/**< @brief Trust calculation type (default='posteriors').  */
  char * type_orig;	/**< @brief Trust calculation type original value given at command line.  */
  const char *type_help; /**< @brief Trust calculation type help description.  */
  int bins_flag;	/**< @brief Output individual bins (default=off).  */
  const char *bins_help; /**< @brief Output individual bins help description.  */

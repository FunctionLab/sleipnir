/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\BNs2Txt\ -i ..\..\..\tools\BNs2Txt\BNs2Txt.ggo 
...
const char *gengetopt_args_info_purpose = "Text/binary minimal Bayes net file interconversion";

const char *gengetopt_args_info_usage = "Usage: BNs2Txt [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nMain:",
  "  -i, --input=filename     Input Bayes net file",
  "  -o, --output=directory   Output Bayes net directory  (default=`.')",
  "  -d, --datasets=filename  Dataset names",
  "\nOptional:",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->xdsl_help = gengetopt_args_info_help[7] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:d:xv:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'i':	/* Input Bayes net file.  */
          ...
          break;
        case 'o':	/* Output Bayes net directory.  */

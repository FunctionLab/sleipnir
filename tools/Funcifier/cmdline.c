/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe -u --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Funcifier\ -i ..\..\..\tools\Funcifier\Funcifier.ggo 
...
const char *gengetopt_args_info_purpose = "Function interaction network builder";

const char *gengetopt_args_info_usage = "Usage: Funcifier [OPTIONS]... [FILES]...";
...
char *cmdline_parser_shared_values[] = {"ignore", "discard", "oneonly", 0} ;	/* Possible values for shared.  */
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->shared_arg = gengetopt_strdup ("discard");
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->shared_arg));
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 's':	/* Determine shared gene handling.  */
          ...
          if (update_arg( (void *)&(args_info->shared_arg), 
               &(args_info->shared_orig), &(args_info->shared_given),
              &(local_args_info.shared_given), optarg, cmdline_parser_shared_values, "discard", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "shared", 's',
              additional_error))
            goto failure;
          ...
          break;
        case 'l':	/* Function cohesiveness output file.  */

...
const char *gengetopt_args_info_purpose = "Search based on correlation of aggregated dataset";

const char *gengetopt_args_info_usage = "Usage: SeekAggregatedDataset [OPTIONS]... [FILES]...";

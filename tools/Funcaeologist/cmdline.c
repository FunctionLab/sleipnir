/*
  ...
  /Genomics/Users/mark/sleipnir/extlib/gengetopt-2.22/src/gengetopt -iFuncaeologist.ggo --default-optional -u -N -e 
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVg:d:nmv:", long_options, &option_index);

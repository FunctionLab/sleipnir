/*
  ...
  ..\gengetopt-2.13.1\Release\gengetopt.exe -u -N -e -i Funcaeologist.ggo 
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n%s\n", "Measures association of gene sets within a collection of networks");
  printf("\nUsage: Funcaeologist [OPTIONS]... [FILES]...\n\n");
  ...
  while (1)
    {
      ...
      stop_char = 0;
      c = getopt_long (argc, argv, "hVg:d:mv:", long_options, &option_index);

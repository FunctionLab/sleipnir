...
struct gengetopt_args_info
{
  ...
  int one_gene_per_file_flag;	/**< @brief Each DB output file will contain the data for only one gene (default=off).  */
  const char *one_gene_per_file_help; /**< @brief Each DB output file will contain the data for only one gene help description.  */
  ...
  unsigned int one_gene_per_file_given ;	/**< @brief Whether one_gene_per_file was given.  */

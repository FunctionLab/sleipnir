/*
  ...
  /usr/local/bin/gengetopt -iData2DB.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_usage = "Usage: Data2DB [OPTION]... [FILE]...";
...
const char *gengetopt_args_info_help[] = {
        ...
        "  -g, --one_gene_per_file   Each DB output file will contain the data for only\n                              one gene  (default=off)",
...
void clear_given(struct gengetopt_args_info *args_info) {
    ...
    args_info->one_gene_per_file_given = 0;
...
void clear_args(struct gengetopt_args_info *args_info) {
    ...
    args_info->one_gene_per_file_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info) {
    ...
    args_info->one_gene_per_file_help = gengetopt_args_info_help[17];
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info) {
    ...
    if (args_info->one_gene_per_file_given)
        write_into_file(outfile, "one_gene_per_file", 0, 0);
...
cmdline_parser_internal(
    ...
    while (1) {
        ...
        static struct option long_options[] = {
                ...
                {"buffer",            0, NULL, 'u'},
                {"memmap",            0, NULL, 'm'},
                {"one_gene_per_file", 0, NULL, 'g'},
                {"verbosity",         1, NULL, 'v'},
                {0,                   0, 0,    0}
        };

        c = getopt_long(argc, argv, "hVx:n:i:d:D:f:b:B:NZ:umgv:", long_options, &option_index);
        ...
        switch (c) {
            ...
            case 'm':    /* Memory map input/output.  */
                ...
                break;
            case 'g':    /* Each DB output file will contain the data for only one gene.  */


                if (update_arg((void *) &(args_info->one_gene_per_file_flag), 0, &(args_info->one_gene_per_file_given),
                               &(local_args_info.one_gene_per_file_given), optarg, 0, 0, ARG_FLAG,
                               check_ambiguity, override, 1, 0, "one_gene_per_file", 'g',
                               additional_error))
                    goto failure;

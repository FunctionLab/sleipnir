/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Data2DB\ -i ..\..\..\tools\Data2DB\Data2DB.ggo 
...
const char *gengetopt_args_info_usage = "Usage: Data2DB [OPTIONS]...";
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->network_help = gengetopt_args_info_help[3] ;
  ...
  args_info->files_help = gengetopt_args_info_help[8] ;
  args_info->block_files_help = gengetopt_args_info_help[9] ;
  args_info->block_datasets_help = gengetopt_args_info_help[10] ;
  args_info->buffer_help = gengetopt_args_info_help[12] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVn:i:d:D:f:b:B:umv:", long_options, &option_index);

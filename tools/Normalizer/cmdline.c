/*
  ...
  ../gengetopt-2.13.1/bin/gengetopt -N -e -i Normalizer.ggo 
...
char *type_values[] = {"pcl", "dat", 0} ;	/* Possible values for type.  */
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->type_arg = gengetopt_strdup ("dat");
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n%s\n", "Data file normalizer.");
  printf("\nUsage: Normalizer [OPTIONS]...\n\n");
  printf("%s\n","  -h, --help             Print help and exit");
  printf("%s\n","  -V, --version          Print version and exit");
  printf("%s\n","\nOptional:");
  printf("%s\n","  -i, --input=filename   Input/output dat/pcl file");
  ...
  printf("%s\n","  -z, --zscore           Normalize values as z-scores  (default=on)");
  ...
  while (1)
    {
      ...
      stop_char = 0;
      c = getopt_long (argc, argv, "hVi:t:o:v:fzs:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'i':	/* Input/output dat/pcl file.  */
        ...
        case 'z':	/* Normalize values as z-scores.  */

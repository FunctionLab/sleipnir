/*
  ...
  ..\..\..\..\extlib\proj\vs2008\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\CHUTTENH\My Documents\Visual Studio 2008\Projects\sleipnir\trunk\tools\Normalizer\ -i ..\..\..\tools\Normalizer\Normalizer.ggo 
...
const char *gengetopt_args_info_usage = "Usage: Normalizer [OPTIONS]...";
      ...
      switch (c)
        ...
        case 'T':	/* Normalization type.  */
          ...
          if (update_arg( (void *)&(args_info->otype_arg), 
              ...
              &(local_args_info.otype_given), optarg, cmdline_parser_otype_values, "globalz", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "otype", 'T',
              additional_error))
            goto failure;

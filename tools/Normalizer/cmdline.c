/*
  ...
  ..\..\..\..\extlib\proj\vs2005\release\gengetopt.exe --default-optional -N -e --output-dir=c:\Documents and Settings\eblis\My Documents\Visual Studio 2008\Projects\Sleipnir\trunk\tools\Normalizer\ -i ..\..\..\tools\Normalizer\Normalizer.ggo 
...
char *cmdline_parser_type_values[] = {"pcl", "dat", 0} ;	/* Possible values for type.  */
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:t:fzs:v:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 't':	/* Data file type.  */
          ...
          if (update_arg( (void *)&(args_info->type_arg), 
              ...
              &(local_args_info.type_given), optarg, cmdline_parser_type_values, "dat", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "type", 't',
              additional_error))
            goto failure;

/*
  ...
  /home/chuttenh/hg/sleipnir/trunk/../extlib/gengetopt-2.22/bin/gengetopt -iNormalizer.ggo --default-optional -u -N -e 
...
const char *gengetopt_args_info_purpose = "Data file normalizer.";

const char *gengetopt_args_info_usage = "Usage: Normalizer [OPTIONS]... [FILES]...";
...
char *cmdline_parser_otype_values[] = {"columnz", "rowz", "globalz", "column0", "0to1", "colcenter", "medmult",
                                       "colfrac", "sigmoid", "normcdf", "pcc", 0};    /* Possible values for otype.  */
...
void clear_given(struct gengetopt_args_info *args_info) {
    ...
    args_info->itype_given = 0;
    args_info->otype_given = 0;
...
void clear_args(struct gengetopt_args_info *args_info) {
    ...
    args_info->itype_arg = gengetopt_strdup("dat");
    args_info->itype_orig = NULL;
    args_info->otype_arg = gengetopt_strdup("globalz");
    args_info->otype_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info) {
    ...
    args_info->itype_help = gengetopt_args_info_help[5];
    args_info->otype_help = gengetopt_args_info_help[6];
    args_info->flip_help = gengetopt_args_info_help[8];
...
cmdline_parser_release(struct gengetopt_args_info *args_info) {
    ...
    free_string_field(&(args_info->itype_arg));
    free_string_field(&(args_info->itype_orig));
    free_string_field(&(args_info->otype_arg));
    free_string_field(&(args_info->otype_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info) {
    ...
    if (args_info->itype_given)
        write_into_file(outfile, "itype", args_info->itype_orig, cmdline_parser_itype_values);
    if (args_info->otype_given)
        write_into_file(outfile, "otype", args_info->otype_orig, cmdline_parser_otype_values);
...
cmdline_parser_internal(int argc, char *const *argv, struct gengetopt_args_info *args_info,
    ...
    while (1) {
        ...
        c = getopt_long(argc, argv, "hVi:o:t:T:fs:v:", long_options, &option_index);
        ...
        switch (c) {
            ...
            case 'V':    /* Print version and exit.  */
                ...
                break;
            case 'i':    /* Input/output PCL/DAT/DAB file.  */
            ...
            case 't':    /* Data file type.  */
                ...
                if (update_arg((void *) &(args_info->itype_arg),
                               &(args_info->itype_orig), &(args_info->itype_given),
                               &(local_args_info.itype_given), optarg, cmdline_parser_itype_values, "dat", ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "itype", 't',
                               additional_error))
                    goto failure;
                ...
                break;
            case 'T':    /* Normalization type.  */


                if (update_arg((void *) &(args_info->otype_arg),
                               &(args_info->otype_orig), &(args_info->otype_given),
                               &(local_args_info.otype_given), optarg, cmdline_parser_otype_values, "globalz",
                               ARG_STRING,
                               check_ambiguity, override, 0, 0,
                               "otype", 'T',
                               additional_error))

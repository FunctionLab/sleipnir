...
#define CMDLINE_PARSER_PACKAGE "Normalizer"
#endif
...
{
  char * input_arg;	/* Input/output dat/pcl file.  */
  char * type_arg;	/* Data file type (default='dat').  */
  char * output_arg;	/* Output dab file.  */
  int verbosity_arg;	/* Message verbosity (default='5').  */
  int flip_flag;	/* Flip high/low scores (default=off).  */
  int zscore_flag;	/* Normalize values as z-scores (default=on).  */
